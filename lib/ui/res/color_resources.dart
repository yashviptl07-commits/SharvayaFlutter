...
const colorBlackInput = const Color(0xff2E303C);
const colorBlackOptions = const Color(0xff2E2727);
const colorBlackTitles = const Color(0xff333333);
...
const colorGreenProgress = const Color(0xff1e9654);
const colorGreenLight = const Color(0xffdbffe1);
const colorGreenVeryLight = const Color(0xffD7E2D7);
const colorGreenDark = const Color(0xff2B4124);
const colorGreen = const Color(0xff2D9835);
const colorYellow = const Color(0xffF5CB49);
const colorYellowDark = const Color(0xff917435);
...
const darkBlueColor = const Color(0xec011b2a);
