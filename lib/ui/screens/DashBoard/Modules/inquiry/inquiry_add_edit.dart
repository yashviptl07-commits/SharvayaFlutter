...
class _InquiryAddEditScreenState extends BaseState<InquiryAddEditScreen>
  ...
  void initState() {
    ...
    _inquiryBloc.add(ConstantRequestEvent(
        CompanyID.toString(),
        ConstantRequest(
            ConstantHead: "InquiryAssign", CompanyId: CompanyID.toString())));
      ...
      child: BlocConsumer<InquiryBloc, InquiryStates>(
        builder: (BuildContext context, InquiryStates state) {
          ...
          if (state is ConstantResponseState) {
            _onConstantResponseState(state);
          }
...
*/
  ...
  void fillData() async {
    ...
    edt_EmployeeID.text = _editModel.assignToEmployee.toString();
    edt_EmployeeName.text = _editModel.assignedEmployeeName;
  ...
  _onTapToSaveHeaderDetails() async {
    ...
    if (edt_InquiryDate.text.toString().trim() != '') {
      if (edt_CustomerName.text.toString().trim() != '') {
        if (edt_LeadStatus.text.toString().trim() != "") {
                  ...
                  showCommonDialogWithTwoOptions(
                    ...
                    _inquiryBloc.add(InquiryHeaderSaveNameCallEvent(
                        ...
                        InquiryHeaderSaveRequest(
                            ...
                            CompanyId: CompanyID.toString(),
                            AssignToEmployee: edt_EmployeeID.text == '0'
                                ? "0"
                                : edt_EmployeeID.text,
          ...
          showCommonDialogWithSingleOption(context, "Lead Status is required!",
              positiveButtonTitle: "OK");
        }
      } else {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          ConstantMAster.toLowerCase() == "yes"
              ? Column(
                  children: [
                    SizedBox(
                      height: 5,
  ...
  void _onConstantResponseState(ConstantResponseState state) {
