...
class _SearchInquiryScreenFilterState
            ...
            child: Column(
              children: [
                ...
                _searchInquiryListResponse == null
                    ? Container()
                    : Expanded(flex: 1, child: _buildInquiryList()),

                Expanded(flex: 2, child: _buildSearchView()),
            ...
            child: Row(
              children: [
                ...
                getCommonButton(baseTheme, () {
                  ...
                  String CustomerName = edt_customerName.text == null
                      ? ""
                      : edt_customerName.text;
                  String ProductName = _productNameController.text == null
                      ? ""
                      : _productNameController.text;
                  String InquiryNo =
                      edt_InquiryNo.text == null ? "" : edt_InquiryNo.text;
                  String StateCode = edt_QualifiedStateCode.text == null
                      ? ""
                      : edt_QualifiedStateCode.text;
                  String CityCode = edt_QualifiedCityCode.text == null
                      ? ""
                      : edt_QualifiedCityCode.text;
                  String CountryCode = edt_QualifiedCountryCode.text == null
                      ? ""
                      : edt_QualifiedCountryCode.text;
                  String Priority =
                      edt_Priority.text == null ? "" : edt_Priority.text;
                  String NameOnly = "1";
                  String Word = "";
  ...
  Widget _buildInquiryList() {
    ...
    return _searchInquiryListResponse.details.length != 0
        ? Container(
            padding: EdgeInsets.all(8),
            decoration: BoxDecoration(border: Border.all(color: colorYellow)),
