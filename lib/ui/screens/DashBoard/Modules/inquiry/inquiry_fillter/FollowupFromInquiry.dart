...
class AddUpdateFollowupFromInquiryScreenArguments {
  FilterDetails editModel;

  AddUpdateFollowupFromInquiryScreenArguments(this.editModel);
}

class FollowUpFromInquiryAddEditScreen extends BaseStatefulWidget {
  static const routeName = '/FollowUpFromInquiryAddEditScreen';
  final AddUpdateFollowupFromInquiryScreenArguments arguments;

  FollowUpFromInquiryAddEditScreen(this.arguments);

  @override
  _FollowUpFromInquiryAddEditScreenState createState() =>
      _FollowUpFromInquiryAddEditScreenState();
}

class _FollowUpFromInquiryAddEditScreenState
    extends BaseState<FollowUpFromInquiryAddEditScreen>
