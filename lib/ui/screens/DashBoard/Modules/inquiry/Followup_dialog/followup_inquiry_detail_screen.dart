...
class AddUpdateFollowupInquiryScreenArguments {
  FilterDetails editModel;

  AddUpdateFollowupInquiryScreenArguments(this.editModel);
}

class FollowUpInquiryAddEditScreen extends BaseStatefulWidget {
  static const routeName = '/FollowUpInquiryAddEditScreen';
  final AddUpdateFollowupInquiryScreenArguments arguments;

  FollowUpInquiryAddEditScreen(this.arguments);

  @override
  _FollowUpInquiryAddEditScreenState createState() =>
      _FollowUpInquiryAddEditScreenState();
}

class _FollowUpInquiryAddEditScreenState
    extends BaseState<FollowUpInquiryAddEditScreen>
