...
class AddUpdateInquiryScreenArguments1 {
  InquiryDetails1 editModel;

  AddUpdateInquiryScreenArguments1(this.editModel);
}

class InquiryAddEditScreen1 extends BaseStatefulWidget {
  static const routeName = '/InquiryAddEditScreen1';
  final AddUpdateInquiryScreenArguments1 arguments;

  InquiryAddEditScreen1(this.arguments);

  @override
  _InquiryAddEditScreen1State createState() => _InquiryAddEditScreen1State();
}

class _InquiryAddEditScreen1State extends BaseState<InquiryAddEditScreen1>
...
*/
  ...
  Future<bool> _onBackPressed() async {
    await _onTapOfDeleteALLProduct();
    navigateTo(context, MudraInquiryListScreen.routeName, clearAllStack: true);
  }
  ...
  void fillData() async {
    ...
    edt_LeadSourceID.text = _editModel.inquirySourceID.toString();
                ...
                showCommonDialogWithTwoOptions(
                  ...
                  _inquiryBloc.add(InquiryHeaderSaveNameCallEvent(
                      ...
                      InquiryHeaderSaveRequest(
                          pkID: pkID.toString(),
                          FollowupDate: isNextFollowupReq == true
