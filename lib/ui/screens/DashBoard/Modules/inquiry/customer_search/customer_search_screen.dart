...
class _SearchInquiryCustomerScreenState
    ...
    return BlocProvider(
      ...
      child: BlocConsumer<InquiryBloc, InquiryStates>(
        builder: (BuildContext context, InquiryStates state) {
          if (state is InquiryCustomerListByNameCallResponseState) {
            _onSearchInquiryListCallSuccess(state);
          }
          return super.build(context);
        },
        buildWhen: (oldState, currentState) {
          if (currentState is InquiryCustomerListByNameCallResponseState) {
            return true;
          }
          return false;
        },
  ...
  void _onSearchInquiryListCallSuccess(
      InquiryCustomerListByNameCallResponseState state) {
