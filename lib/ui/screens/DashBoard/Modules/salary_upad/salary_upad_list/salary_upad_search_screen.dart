...
class SearchSalaryUpadScreen extends BaseStatefulWidget {
  static const routeName = '/SearchSalaryUpadScreen';

  @override
  _SearchSalaryUpadScreenState createState() => _SearchSalaryUpadScreenState();
}

class _SearchSalaryUpadScreenState extends BaseState<SearchSalaryUpadScreen>
    ...
    return BlocProvider(
      ...
      child: BlocConsumer<SalaryUpadScreenBloc, SalaryUpadScreenStates>(
        ...
        buildWhen: (oldState, currentState) {
          if (currentState is SalaryUpadSearchResponseState) {
            return true;
          }
          return false;
        },
