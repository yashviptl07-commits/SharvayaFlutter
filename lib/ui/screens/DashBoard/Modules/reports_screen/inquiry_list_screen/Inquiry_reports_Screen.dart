...
class InquiryReportListScreen extends BaseStatefulWidget {
  static const routeName = '/InquiryReportListScreen';

  @override
  _InquiryReportListScreenState createState() => _InquiryReportListScreenState();
}

class _InquiryReportListScreenState extends BaseState<InquiryReportListScreen>
  ...
  void initState() {
    ...
    _mainBloc
      .add(InquiryListReportCallEvent(
          1,
    ...
    return BlocProvider(
      ...
      child: BlocConsumer<MainBloc, MainStates>(
        builder: (BuildContext context, MainStates state) {
          if (state is InquiryListResponseCallResponseState) {
            _onCustomerReportsResponseSuccess(state);
          }
          return super.build(context);
        },
        buildWhen: (oldState, currentState) {
          if (currentState is InquiryListResponseCallResponseState) {
            return true;
          }
          return false;
        },
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: NewGradientAppBar(
          title: Text('Inquiry Reports Screen'),
  ...
  Widget ExpantionCustomer(BuildContext context, int index) {
    List<InquiryDetails> PD = Response.details;
  ...
  void _displayPdf(List<InquiryDetails> productPaginationDetails) {
      ...
      pw.MultiPage(
        ...
        build: (pw.Context context) => [
          pw.Header(
              ...
              pw.Center(
                child: pw.Text('Inquiry Report', style: pw.TextStyle(fontSize: 25, fontWeight: pw.FontWeight.bold)),
              )
          ),
          pw.SizedBox(
              height: 40
          ...
          pw.Table.fromTextArray(
            ...
            headers: ['Sr No.', 'Inquiry No', 'Date', 'Customer', 'Reference', 'Source', 'City' , 'State' ,'Status','Employee','Total Amount'],
            columnWidths: {
            ...
            data:List<List<dynamic>>.generate(
              productPaginationDetails.length,
                ...
                productPaginationDetails[index].referenceName,
    ...
    Navigator.push(context, MaterialPageRoute(builder: (context) => PreviewScreen(doc: doc, PdfName: "InquiryReport")));
  }
  ...
  void _onCustomerReportsResponseSuccess(InquiryListResponseCallResponseState state) {
