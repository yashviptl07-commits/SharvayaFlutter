...
class AddUpdateCashVoucherArguments2 {
  MayankBankVoucherListDetails editModel;
  AddUpdateCashVoucherArguments2(this.editModel);
}

class MayankCashVoucherAddEdit extends BaseStatefulWidget {
  static const routeName = '/MayankCashVoucherAddEdit';
  final AddUpdateCashVoucherArguments2 arguments;

  MayankCashVoucherAddEdit(this.arguments);

  @override
  _MayankCashVoucherAddEditScreen createState() =>
      _MayankCashVoucherAddEditScreen();
}

class _MayankCashVoucherAddEditScreen
    extends BaseState<MayankCashVoucherAddEdit>
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: NewGradientAppBar(
          title: Text('Manage Cash Voucher'),
                ...
                child: Column(
                  children: [
                    ...
                    showcustomdialogWithID1("Transaction Mode",
                        ...
                        hintTextvalue: "--- Select Transaction Mode ---",
                        icon: Icon(
                    ...
                    InkWell(
                      onTap: () {
                        ...
                        navigateTo(
                            ...
                            context,
                            MaintenanceDetailsListScreen1.routeName,
                            arguments: MaintenanceDetailsListScreenArgument1(
                                pkID, CustomerId));
                  ...
                  children: [
                    Expanded(
                      child: TextField(
                          ...
                          decoration: InputDecoration(
                            counterText: "",
                            hintText: "Tap to enter TDS Amount",
                            contentPadding:
                                EdgeInsets.only(bottom: 12, top: 12),
                            labelStyle: TextStyle(
                              color: Color(0xFF000000),
                  ...
                  Expanded(
                    child: Text(
                      ...
                      style: baseTheme.textTheme.displaySmall.copyWith(
                          color: edt_Voucher_date.text == null ||
                                  edt_Voucher_date.text == ""
                              ? colorGrayDark
                              : colorBlack),
                    ),
...
/*  Future<void> _PunchDate(
  ...
  Widget TransactionDateChequeDate() {
    return InkWell(
      onTap: () {
        _TransactionDateChequeDate(context, edt_Voucher_date);
      },
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
  ...
  /* void _onVehicleDropDown(VehiclePunchVehicleDropdownResponseState state) {
    arr_ALL_Name_ID_For_vehicle.clear();
    if (state.response.details.length != 0) {
      for (var i = 0; i < state.response.details.length; i++) {
        ...
        categoryResponse123.Name = state.response.details[i].registrationNo;
        categoryResponse123.pkID = state.response.details[i].pkID;
        arr_ALL_Name_ID_For_vehicle.add(categoryResponse123);
      }

      if (arr_ALL_Name_ID_For_vehicle.length != 0) {
        */ /* showcustomdialogWithID(
            values: arr_ALL_Name_ID_For_Outsource,
            context1: context,
            controller: edt_Outsource,
            controllerID: edt_OutsourceId,
            lable: "Select Outsource");*/ /*
        navigateTo(context, VehicleListDropDownScreen.routeName,
            arguments: VehicleListDropDownScreenArgument(
                arr_ALL_Name_ID_For_vehicle,
                "Outsource List",
                "Three chars to search outsource",
                "Tap to enter outsource name"))
            .then((value) {
          if (value.toString() == "clear") {
            ...
            edt_vehicle.text = model.Name;
            edt_vehicleId.text = model.pkID.toString();
          }
                ...
                showCommonDialogWithTwoOptions(
                  ...
                  _mainBloc.add(MayankBankVoucherSaveCallEvent(
                      MayankBankVoucherAddEditRequest(
                          ...
                          TDSAccountID: "",
                          TransType: "acc",
                          TransModeID: edt_TransectionMode_ID.text == null
                              ? ""
