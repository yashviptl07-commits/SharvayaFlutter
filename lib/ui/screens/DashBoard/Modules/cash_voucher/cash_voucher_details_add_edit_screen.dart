...
class AddMaintenanceDetailsScreenArguments1 {
  int pkId;
  String CustomerId;
  AddMaintenanceDetailsScreenArguments1(this.pkId, this.CustomerId);
}

class AddMaintenanceDetailsScreen1 extends BaseStatefulWidget {
  static const routeName = '/AddMaintenanceDetailsScreen1';
  final AddMaintenanceDetailsScreenArguments1 arguments;

  AddMaintenanceDetailsScreen1(this.arguments);

  @override
  _AddMaintenanceDetailsScreen1State createState() =>
      _AddMaintenanceDetailsScreen1State();
}

class _AddMaintenanceDetailsScreen1State
    extends BaseState<AddMaintenanceDetailsScreen1>
              ...
              child: Column(
                children: [
                  ...
                  showcustomdialogWithID1("Invoice No",
                      enable1: false,
                      title: "Invoice No",
                      hintTextvalue: "Tap to Select Invoice No",
                      icon: Icon(
    ...
    if (_formKey.currentState.validate()) {
      if (isProductExist == false) {
        ...
        showCommonDialogWithSingleOption(
            context, "Duplicate Data Not Allowed...", positiveButtonTitle: "OK",
