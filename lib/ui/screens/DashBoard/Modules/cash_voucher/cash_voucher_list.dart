...
class MayankCashVoucherListScreen extends BaseStatefulWidget {
  static const routeName = '/MayankCashVoucherListScreen';

  @override
  _MayankCashVoucherListScreenScreen createState() =>
      _MayankCashVoucherListScreenScreen();
}

class _MayankCashVoucherListScreenScreen
    extends BaseState<MayankCashVoucherListScreen>
          ...
          actions: <Widget>[
            IconButton(
              ...
              onPressed: () async {
                ...
                navigateTo(context, MayankCashVoucherAddEdit.routeName,
                    clearAllStack: true);
              },
            ),
            IconButton(
  ...
  void _onTapOfEditVehicleFuel(MayankBankVoucherListDetails model) {
    navigateTo(context, MayankCashVoucherAddEdit.routeName,
            arguments: AddUpdateCashVoucherArguments2(model))
