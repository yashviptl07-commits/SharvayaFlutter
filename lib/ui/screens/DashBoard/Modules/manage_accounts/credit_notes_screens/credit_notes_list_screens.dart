...
class CreditNotesListScreen extends BaseStatefulWidget {
  static const routeName = '/CreditNotesListScreen';

  @override
  _CreditNotesListScreenScreen createState() => _CreditNotesListScreenScreen();
}

class _CreditNotesListScreenScreen extends BaseState<CreditNotesListScreen>
    with BasicScreen, WidgetsBindingObserver {
  MainBloc _mainBloc;
  CreditNotesListResponse _listResponse;
  int _pageNo = 0;
    ...
    return BlocProvider(
      ...
      child: BlocConsumer<MainBloc, MainStates>(
        builder: (BuildContext context, MainStates state) {
          if (state is CreditNotesListCallResponseState) {
            _onCreditNotesListCallResponseStateSuccess(state);
          }
          return super.build(context);
        },
        buildWhen: (oldState, currentState) {
          if (currentState is CreditNotesListCallResponseState) {
            return true;
          }
          return false;
        },
  ...
  void _onCreditNotesListCallResponseStateSuccess(
      CreditNotesListCallResponseState state) {
