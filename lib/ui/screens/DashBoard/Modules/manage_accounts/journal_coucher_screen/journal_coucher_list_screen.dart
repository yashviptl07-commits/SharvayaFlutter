...
class JournalVoucherListScreen extends BaseStatefulWidget {
  static const routeName = '/JournalVoucherListScreen';

  @override
  _JournalVoucherListScreenState createState() =>
      _JournalVoucherListScreenState();
}

class _JournalVoucherListScreenState extends BaseState<JournalVoucherListScreen>
    with BasicScreen, WidgetsBindingObserver {
  MainBloc _mainBloc;
  int _pageNo = 0;
  JournalVoucherListResponse _listResponse;
    ...
    return BlocProvider(
      ...
      child: BlocConsumer<MainBloc, MainStates>(
        builder: (BuildContext context, MainStates state) {
          if (state is JournalVoucherListCallResponseState) {
            _onJournalVoucherListCallResponseStateSuccess(state);
          }
          return super.build(context);
        },
        buildWhen: (oldState, currentState) {
          if (currentState is JournalVoucherListCallResponseState) {
            return true;
          }
          return false;
        },
                  ...
                  Expanded(
                    child: Column(
                      children: [
                        ...
                        _infoTile(r, Icons.trending_down_outlined, "Remark",
                            model.remarks ?? "N/A"),
                      ],
                    ),
                  ),
  ...
  void _onJournalVoucherListCallResponseStateSuccess(
      JournalVoucherListCallResponseState state) {
