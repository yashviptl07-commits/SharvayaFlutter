...
class PettyCashListScreen extends BaseStatefulWidget {
  static const routeName = '/PettyCashListScreen';

  @override
  _PettyCashListScreenState createState() => _PettyCashListScreenState();
}

class _PettyCashListScreenState extends BaseState<PettyCashListScreen>
    with BasicScreen, WidgetsBindingObserver {
  MainBloc _mainBloc;
  int _pageNo = 0;
  PettyCashListResponse _listResponse;
    ...
    return BlocProvider(
      ...
      child: BlocConsumer<MainBloc, MainStates>(
        builder: (BuildContext context, MainStates state) {
          if (state is PettyCashListCallResponseState) {
            _onPettyCashListCallResponseStateSuccess(state);
          }
          return super.build(context);
        },
        buildWhen: (oldState, currentState) {
          if (currentState is PettyCashListCallResponseState) {
            return true;
          }
          return false;
        },
  ...
  void _onPettyCashListCallResponseStateSuccess(
      PettyCashListCallResponseState state) {
