...
class _QuotationListScreenState extends BaseState<QuotationListScreen>
                  ...
                  Container(
                    child: Row(
                        ...
                        children: <Widget>[
                          ...
                          GestureDetector(
                            onTap: () {
                              _onTaptoEditQuotation(model, false);
                            },
                            child: Column(
                              children: [
                                Card(
                              ...
                              ? Container(
                                  child: Row(
                                    children: [
                                      ...
                                      GestureDetector(
                                        onTap: () {
                                          _onTaptoEditQuotation(model, true);
                                        },
                                        child: Row(
                                          children: <Widget>[
                                            Image.asset(
  ...
  void _onTaptoEditQuotation(QuotationDetails model, bool isCopy) async {
    await _onTapOfDeleteALLProduct();

    navigateTo(context, QuotationAddEditScreen.routeName,
            arguments: AddUpdateQuotationScreenArguments(model, isCopy))
        .then((value) {
      _QuotationBloc.add(QuotationListCallEvent(
          1,
          QuotationListApiRequest(
