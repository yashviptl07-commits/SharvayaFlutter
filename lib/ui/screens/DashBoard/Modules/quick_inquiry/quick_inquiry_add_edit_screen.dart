...
class _QuickInquiryScreenState extends BaseState<QuickInquiryScreen>
      ...
      child: BlocConsumer<QuickInquiryBloc, QuickInquiryStates>(
        ...
        listenWhen: (oldState, currentState) {
          if (currentState is CustomerAddEditEventResponseState) {
            ...
            return true;
          } else if (currentState is FCMNotificationResponseNewState) {
            return true;
          }
          return false;
        },
                        ...
                        child: Column(
                          children: [
                            InkWell(
                              onTap: () {
                                setState(() {
                                  IsInquiryDetails = !IsInquiryDetails;
              ...
              if (edt_Country.text != "") {
                if (edt_State.text != "") {
                  if (edt_City.text != "") {
                      ...
                      if (edt_Source.text != '') {
                        if (edt_Priority.text != "") {
                          if (edt_LeadStatus.text != "") {
                            ...
                            showCommonDialogWithSingleOption(
                                context, "Lead Status is required!",
                                positiveButtonTitle: "OK",
                                onTapOfPositiveButton: () {
                              Navigator.pop(context);
                            });
                          ...
                          showCommonDialogWithSingleOption(
                              context, "Lead Priority is required!",
                              positiveButtonTitle: "OK",
                              onTapOfPositiveButton: () {
                            Navigator.pop(context);
                          });
                    ...
                    showCommonDialogWithSingleOption(
                        context, "City is required!", positiveButtonTitle: "OK",
                        onTapOfPositiveButton: () {
                      Navigator.pop(context);
                    });
                  }
                  ...
                  showCommonDialogWithSingleOption(
                      context, "State is required!", positiveButtonTitle: "OK",
                      onTapOfPositiveButton: () {
                    Navigator.pop(context);
                  });
                }
                ...
                showCommonDialogWithSingleOption(
                    context, "Country is required!", positiveButtonTitle: "OK",
                    onTapOfPositiveButton: () {
                  Navigator.pop(context);
                });
              }
      ...
      if (FollowupExist == false) {
        _CustomerBloc.add(InquiryHeaderSaveNameCallEvent(
            ...
            InquiryHeaderSaveRequest(
              ...
              InquirySource: edt_Source.text.toString(),
              ReferenceName: "",
              FollowupNotes: "",
  ...
  void _OnHeaderSuccessResponse(InquiryHeaderSaveResponseState state) {
    ...
    if (ReportToToken != "") {
      _CustomerBloc.add(FCMNotificationRequestNewEvent(message));
    }
  ...
  void _OnInquiryProductSaveResponse(
    ...
    String Msg = "Quick Inquiry Added Successfully !";
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: () {
                        _onTapOfSearchStateView(edt_CountryID.text);
                      },
                      child: Container(
                        margin: EdgeInsets.only(bottom: 20),
                        child: TextFormField(
                    ...
                    InkWell(
                      onTap: () {
                        _onTapOfSearchCityView(edt_StateID.text);
                      },
                      child: Container(
                        margin: EdgeInsets.only(bottom: 20),
                        child: TextFormField(
