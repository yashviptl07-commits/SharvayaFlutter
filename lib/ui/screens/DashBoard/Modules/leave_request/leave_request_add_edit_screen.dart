...
class _LeaveRequestAddEditScreenState
  ...
  final TextEditingController edt_LeaveDays = TextEditingController();
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Card(
                            child: TextFormField(
                              controller: edt_LeaveDays,
                              minLines: 2,
                              maxLines: 5,
                              keyboardType: TextInputType.multiline,
                              decoration: InputDecoration(
                                  contentPadding: EdgeInsets.all(10.0),
                                  hintText: 'Enter leave',
                        ...
                        getCommonButton(baseTheme, () {
                          ...
                          DateTime Fromdatevalid1 =
                              DateFormat("dd-MM-yyyy hh:mm a").parse(
                                  edt_fromDateController.text +
                                      " " +
                                      edt_fromTimeController.text);
                          DateTime ToDateValid1 =
                              DateFormat("dd-MM-yyyy hh:mm a").parse(
                                  edt_toDateController.text +
                                      " " +
                                      edt_toTimeController.text);
                          if (Fromdatevalid1.isBefore(ToDateValid1)) {
                            CheckDate = true;
                            print(
                                "From date is before To date. :white_check_mark: Valid!");
                          } else {
                            CheckDate = false;
                            print(
                                "Error: From date must be before To date! :x:");
                          }
                                    ...
                                    showCommonDialogWithTwoOptions(context,
                                      ...
                                      _leaveRequestScreenBloc.add(LeaveRequestSaveCallEvent(
                                          ...
                                          LeaveRequestSaveAPIRequest(
                                              ...
                                              leaveDays: edt_LeaveDays.text == "" ? "0.00" : edt_LeaveDays.text)));
                                    });
                                  } else {
  ...
  void fillData(LeaveRequestDetails leaveRequestDetails) {
    ...
    edt_LeaveDays.text = leaveRequestDetails.leaveDays.toString();
  }
  ...
  void _onLeaveSaveStatusCallSuccess(
    ...
    if (ReportToToken != "") {
      _leaveRequestScreenBloc.add(FCMNotificationRequestNewEvent(message));
    }
