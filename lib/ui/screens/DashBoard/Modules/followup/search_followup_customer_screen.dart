...
class SearchFollowupCustomerScreen extends BaseStatefulWidget {
  static const routeName = '/SearchFollowupCustomerScreen';

  @override
  _SearchFollowupCustomerScreenState createState() =>
      _SearchFollowupCustomerScreenState();
}

class _SearchFollowupCustomerScreenState
    extends BaseState<SearchFollowupCustomerScreen>
