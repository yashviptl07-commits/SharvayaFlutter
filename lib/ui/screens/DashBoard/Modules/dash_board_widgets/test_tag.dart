...
class TagEmployeeListScreenArguments {
  List<ALL_Name_ID> arr_inquiry_share_emp_list;
  String ModuleName;
  TagEmployeeListScreenArguments(this.arr_inquiry_share_emp_list, this.ModuleName);
}

class TagEmployeeListScreen extends BaseStatefulWidget {
  static const routeName = '/TagEmployeeListScreen';
  final TagEmployeeListScreenArguments arguments;

  TagEmployeeListScreen(this.arguments);

  @override
  _TagEmployeeListScreenState createState() => _TagEmployeeListScreenState();
}

class _TagEmployeeListScreenState extends BaseState<TagEmployeeListScreen>
  ...
  Widget buildBody(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(title: Text("Select Tag Employee"),
