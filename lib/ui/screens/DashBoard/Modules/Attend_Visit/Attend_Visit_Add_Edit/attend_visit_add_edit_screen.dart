...
class _AttendVisitAddEditScreenState extends BaseState<AttendVisitAddEditScreen>
  ...
  final TextEditingController edt_ComplaintNotesFromComplaint = TextEditingController();
                        ...
                        Padding(
                          ...
                          child: Card(
                            ...
                            child: TextFormField(
                              enabled: false,
                              maxLines: 3,
                              controller: edt_ComplaintNotesFromComplaint,
          ...
          InkWell(
            onTap: () {
              if(edt_CustomerName.text != ""){
                ...
                showCommonDialogWithSingleOption(
                    context, "Select Customer And Check If Any Complaint Exist !",
                    positiveButtonTitle: "OK",
                    onTapOfPositiveButton: () {
                      Navigator.of(context).pop();
                    });
  ...
  void fillData() {
    ...
    edt_ComplaintNotesFromComplaint.text = _editModel.complaintNotes;
  }
  ...
  void _onreadcomplaintStatusSucess(ComplaintSearchByIDResponseState state) {
    for (int i = 0; i < state.complaintSearchByIDResponse.details.length; i++) {
      ...
      edt_ComplaintNotesFromComplaint.text =
          state.complaintSearchByIDResponse.details[i].complaintNotes;
    }
  }
