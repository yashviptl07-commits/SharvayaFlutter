...
// You can can also directly ask the permission about its status.
  ...
  LeadStatusDetails() {
    return Visibility(
      visible: true, //isTelecallerFollowup,
      child: Container(
        child: Column(
          children: [
            GestureDetector(
              onTap: () {
                edt_LeadISQualifiedFromAddedit.text == ""?showcustomdialogWithOnlyName(
                          ...
                          children: [
                            Expanded(
                              child: TextField(
                                  ...
                                  style: TextStyle(
                                    fontSize: 15,
                                    color:  edt_LeadISQualifiedFromAddedit.text == ""?Color(0xFF000000):colorGrayDark,
                                  ) // baseTheme.textTheme.headline2.copyWith(color: colorBlack),
