...
class SearchCompanyScreen extends BaseStatefulWidget {
  static const routeName = '/SearchCompanyScreen';
  final SearchCompanyScreenArguments arguments;
  SearchCompanyScreen(this.arguments);

  @override
  _SearchCompanyScreenState createState() => _SearchCompanyScreenState();
}

class _SearchCompanyScreenState extends BaseState<SearchCompanyScreen>
    with BasicScreen, WidgetsBindingObserver {
  TeleCallerBloc _CustomerBloc;
  ...
  void initState() {
    ...
    _CustomerBloc = TeleCallerBloc(baseBloc);
                ...
                Expanded(
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      hintText: "Tap to enter Company name",
