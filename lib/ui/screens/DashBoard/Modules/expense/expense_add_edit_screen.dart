...
class _ExpenseAddEditScreenState extends BaseState<ExpenseAddEditScreen>
  ...
  final TextEditingController edt_TotalDistance = TextEditingController();
          ...
          child: Container(
              ...
              child: Form(
                  ...
                  child: Column(
                      ...
                      children: [
                        _offlineLoggedInData.details[0].serialKey.toLowerCase() != "eldf-ctgh-45sd-sm23"
                            ? _buildFollowupDate()
                            : ExpenseDate(),
                        SizedBox(
                          width: 20,
...
*/
  ...
  Widget DistanceCovered() {
    return Column(
      ...
      children: [
        Container(
          margin: EdgeInsets.only(left: 10, right: 10),
          child: Text("Distance Covered(in km)",
              style: TextStyle(
                  fontSize: 12,
                  color: colorPrimary,
                  fontWeight: FontWeight
              ...
              children: [
                Expanded(
                  child: TextField(
                      ...
                      textInputAction: TextInputAction.next,
                      controller: edt_TotalDistance,
                      decoration: InputDecoration(
                        hintText: "Tap to enter distance",
                        labelStyle: TextStyle(
                          color: Color(0xFF000000),
                        ),
                        border: InputBorder.none,
  ...
  void fillData(ExpenseDetails expenseDetails) async {
    ...
    print("dssdff" + edt_ExpenseType.text);
    ...
    edt_TotalDistance.text = expenseDetails.distanceCovered.toString();
  ...
  Future<void> _selectDate(
      BuildContext context, TextEditingController edt_ExpenseDateController) async {
