...
class GreenEdgeQuotationSpecificationAddEditScreenArguments {
  QuotationSpecificationTable editModel;

  GreenEdgeQuotationSpecificationAddEditScreenArguments(this.editModel);
}

class GreenEdgeQuotationSpecificationAddEditScreen extends BaseStatefulWidget {
  static const routeName = '/GreenEdgeQuotationSpecificationAddEditScreen';
  final GreenEdgeQuotationSpecificationAddEditScreenArguments arguments;

  GreenEdgeQuotationSpecificationAddEditScreen(this.arguments);

  @override
  _GreenEdgeQuotationSpecificationAddEditScreenState createState() =>
      _GreenEdgeQuotationSpecificationAddEditScreenState();
}

class _GreenEdgeQuotationSpecificationAddEditScreenState
    extends BaseState<GreenEdgeQuotationSpecificationAddEditScreen>
