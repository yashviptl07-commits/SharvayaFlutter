...
class GreenEdgeSpecificationListArgument {
  String inquiry_No;
  String ProductID;

  GreenEdgeSpecificationListArgument(this.inquiry_No, this.ProductID);
}

class GreenEdgeSpecificationListScreen extends BaseStatefulWidget {
  static const routeName = '/GreenEdgeSpecificationListScreen';
  final GreenEdgeSpecificationListArgument arguments;

  GreenEdgeSpecificationListScreen(this.arguments);
  @override
  _GreenEdgeSpecificationListScreenState createState() =>
      _GreenEdgeSpecificationListScreenState();
}

class _GreenEdgeSpecificationListScreenState extends BaseState<GreenEdgeSpecificationListScreen>
...
*/
    ...
    navigateTo(context, GreenEdgeQuotationSpecificationAddEditScreen.routeName,
            arguments: GreenEdgeQuotationSpecificationAddEditScreenArguments(model))
        .then((value) {
