...
class OldAddGreenEdgeQuotationProductScreenArguments {
  QuotationTable model;
  int StateCode;
  String HeaderDiscAmnt;
  String QuotationNo;

  OldAddGreenEdgeQuotationProductScreenArguments(
...
class OldAddGreenEdgeQuotationProductScreen extends BaseStatefulWidget {
  static const routeName = '/OldAddGreenEdgeQuotationProductScreen';
  final OldAddGreenEdgeQuotationProductScreenArguments arguments;

  OldAddGreenEdgeQuotationProductScreen(this.arguments);

  @override
  _OldAddGreenEdgeQuotationProductScreenState createState() =>
      _OldAddGreenEdgeQuotationProductScreenState();
}

class _OldAddGreenEdgeQuotationProductScreenState
    extends BaseState<OldAddGreenEdgeQuotationProductScreen>
                            ...
                            children: [
                              Expanded(
                                child: getCommonButton(baseTheme, () async {
                                  ...
                                  navigateTo(context,
                                      GreenEdgeSpecificationListScreen.routeName,
                                          arguments: GreenEdgeSpecificationListArgument(
                                              _QuotationNo,
                              ...
                              Visibility(
                                ...
                                child: Expanded(
                                  child: getCommonButton(baseTheme, () async {
                                    ...
                                    navigateTo(
                                            context, GreenEdgeQTAssemblyScreen.routeName,
                                            arguments: GreenEdgeQTAssemblyScreenArgument(
                                                _QuotationNo,
                                                _productIDController.text
                                                    .toString()))
                                        .then((value) {
