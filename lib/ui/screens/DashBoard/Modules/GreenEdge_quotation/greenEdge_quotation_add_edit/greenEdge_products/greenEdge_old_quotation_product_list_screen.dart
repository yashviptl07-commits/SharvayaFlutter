...
class OldGreenEdgeQuotationProductListScreenArgument {
  String quotation_No;
  String stateCode;
...
class OldGreenEdgeQuotationProductListScreen extends BaseStatefulWidget {
  static const routeName = '/OldGreenEdgeQuotationProductListScreen';
  final OldGreenEdgeQuotationProductListScreenArgument arguments;
  OldGreenEdgeQuotationProductListScreen(this.arguments);
  @override
  _OldGreenEdgeQuotationProductListScreenState createState() =>
      _OldGreenEdgeQuotationProductListScreenState();
}

class _OldGreenEdgeQuotationProductListScreenState
    extends BaseState<OldGreenEdgeQuotationProductListScreen>
        ...
        children: [
          ...
          FloatingActionButton(
            ...
            onPressed: () async {
              ...
              await navigateTo(context, OldAddGreenEdgeQuotationProductScreen.routeName,
                  arguments: OldAddGreenEdgeQuotationProductScreenArguments(
...
//right now calling again get contacts, later it can be optimized
  ...
  Future<void> _onTapOfEditContact(int index) async {
    ...
    navigateTo(context, OldAddGreenEdgeQuotationProductScreen.routeName,
        arguments: OldAddGreenEdgeQuotationProductScreenArguments(
