...
class GreenEdgeQTAssemblyAddEditScreenArguments {
  QTAssemblyTable editModel;
  String finishedProductID;
  String FromAddEdit;

  GreenEdgeQTAssemblyAddEditScreenArguments(
      this.editModel, this.finishedProductID, this.FromAddEdit);
}

class GreenEdgeQTAssemblyAddEditScreen extends BaseStatefulWidget {
  static const routeName = '/GreenEdgeQTAssemblyAddEditScreen';

  final GreenEdgeQTAssemblyAddEditScreenArguments arguments;

  GreenEdgeQTAssemblyAddEditScreen(this.arguments);

  @override
  _GreenEdgeQTAssemblyAddEditScreenState createState() =>
      _GreenEdgeQTAssemblyAddEditScreenState();
}

class _GreenEdgeQTAssemblyAddEditScreenState extends BaseState<GreenEdgeQTAssemblyAddEditScreen>
...
*/
  ...
  void QTAssemblyTableUpdateResponse(QTAssemblyTableUpdateState state) {
    print("mdf" + state.response.toString());
    navigateTo(context, GreenEdgeQTAssemblyScreen.routeName);
