...
class GreenEdgeQTAssemblyScreenArgument {
  String quotation_No;
  String finishProductID;

  GreenEdgeQTAssemblyScreenArgument(this.quotation_No, this.finishProductID);
}

class GreenEdgeQTAssemblyScreen extends BaseStatefulWidget {
  static const routeName = '/GreenEdgeQTAssemblyScreen';
  final GreenEdgeQTAssemblyScreenArgument arguments;
  GreenEdgeQTAssemblyScreen(this.arguments);
  @override
  _GreenEdgeQTAssemblyScreenState createState() => _GreenEdgeQTAssemblyScreenState();
}

class _GreenEdgeQTAssemblyScreenState extends BaseState<GreenEdgeQTAssemblyScreen>
