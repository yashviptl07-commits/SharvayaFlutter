...
class AddUpdateGreenEdgeQuotationScreenArguments {
  QuotationDetails editModel;
  QuoShipmentlistResponseDetails soShipmentlistResponseDetails;

  AddUpdateGreenEdgeQuotationScreenArguments(this.editModel,this.soShipmentlistResponseDetails);
}

class GreenEdgeQuotationAddEditScreen extends BaseStatefulWidget {
  static const routeName = '/GreenEdgeQuotationAddEditScreen';
  final AddUpdateGreenEdgeQuotationScreenArguments arguments;

  GreenEdgeQuotationAddEditScreen(this.arguments);

  @override
  _GreenEdgeQuotationAddEditScreenState createState() => _GreenEdgeQuotationAddEditScreenState();
}

class _GreenEdgeQuotationAddEditScreenState extends BaseState<GreenEdgeQuotationAddEditScreen>
  ...
  QuoShipmentlistResponseDetails _soShipmentlistResponseDetails;
    ...
    return BlocProvider(
      ...
      child: BlocConsumer<QuotationBloc, QuotationStates>(
        ...
        listener: (BuildContext context, QuotationStates state) {
          ...
          if (state is GreenEdgeQuotationHeaderSaveResponseState) {
        ...
        listenWhen: (oldState, currentState) {
          if (currentState is QuotationNoToProductListCallResponseState ||
                  ...
                  currentState is GreenEdgeQuotationHeaderSaveResponseState ||
  ...
  Widget _BuildOrgDropDown() {
    return InkWell(
      onTap: () {
        if (edt_CustomerName.text != "") {
          _inquiryBloc.add(SalesOrderAddressORGDropDownRequestEvent(
...
/*  _onTapOfSearchCountryView(String sw) {
                        ...
                        Container(
                          ...
                          child: getCommonButton(baseTheme, () async {
                            if (edt_CustomerName.text != "") {
                              ...
                              navigateTo(context,
                                  OldGreenEdgeQuotationProductListScreen.routeName,
                                      arguments:
                                      OldGreenEdgeQuotationProductListScreenArgument(
                                              InquiryNo,
                                              edt_StateCode.text,
                                              edt_HeaderDisc.text))
                                  .then((value) async {
                          ...
                          child: Container(
                            ...
                            child: getCommonButton(baseTheme, () async {
                              ...
                              if (_inquiryProductList.length != 0) {
                                ...
                                navigateTo(context,
                                    NewGreenEdgeQuotationOtherChargeScreen.routeName,
                                        arguments:
                                        NewGreenEdgeQuotationOtherChargeArguments(
                                                int.parse(
  ...
  Future<void> _onTapOfSearchView() async {
    if (_isForUpdate == false) {
      ...
      navigateTo(context, SearchGreenEdgeQuotationCustomerScreen.routeName)
          .then((value) {
        if (value != null) {
  ...
  Future<bool> _onBackPressed() async {
    await _onTapOfDeleteALLProduct();
    navigateTo(context, GreenEdgeQuotationListScreen.routeName, clearAllStack: true);
  }
  ...
  void fillData() async {
    ...
    if (_editModel.quotationNo != '') {
      // await _onTapOfDeleteALLProduct();
      _inquiryBloc.add(QuotationNoToProductListCallEvent(
          StateCode,
          QuotationNoToProductListRequest(
              QuotationNo: _editModel.quotationNo, CompanyId: CompanyID.toString())));
    }
    ...
    print("ChargePer1__" + " ChargePer1 : " + _editModel.ChargePer1.toStringAsFixed(2));
    print("ChargePer2__" + " ChargePer2 : " + _editModel.ChargePer2.toStringAsFixed(2));
    print("ChargePer3__" + " ChargePer3 : " + _editModel.ChargePer3.toStringAsFixed(2));
    print("ChargePer4__" + " ChargePer4 : " + _editModel.ChargePer4.toStringAsFixed(2));
    print("ChargePer5__" + " ChargePer5 : " + _editModel.ChargePer5.toStringAsFixed(2));
    ...
    _inquiryBloc.add(QuotationOtherChargeCallEvent(_editModel.discountAmt.toString(),CompanyID.toString(),
      ...
      if (edt_CustomerName.text != "") {
        if (edt_Portal_details.text != "") {
          if (temp.length != 0) {
            ...
            List<double> finalPrice = UpdateHeaderDiscountCalculationNew(TempproductList);
            ...
            /*  if (InquiryNo != '') {
              ...
              _inquiryBloc.add(GreenEdgeQuotationHeaderSaveCallEvent(
                  context,
                  pkID,
                  QuotationHeaderSaveRequest(
                      ...
                      QuotationKindAttn:edt_KindAtt.text
                  ),
  ...
  void _OnQuotationHeaderSaveSucessResponse(
      GreenEdgeQuotationHeaderSaveResponseState state) {
    int returnPKID = 0;
    String retrunQT_No = "";
    for (int i = 0; i < state.response.details.length; i++) {
  ...
  void updateRetrunInquiryNoToDB(BuildContext context1, int pkID, String ReturnQT_No) async {
    ...
    List<NewQuotationProductTable> arrNewQuotationProductTable = [];
    for(int i=0;i<TempproductList.length;i++)
    {
      NewQuotationProductTable vmsQuotationTable =
      NewQuotationProductTable(
        id:TempproductList[i].id,
        QuotationNo:ReturnQT_No,
        ProductSpecification: TempproductList[i].ProductSpecification.toString(),
        ...
        DiscountPercent:TempproductList[i].DiscountPercent,//edt_final_disc_per.text.toString()=="null"?"0.00":double.parse(edt_final_disc_per.text.toString()),
        DiscountAmt:TempproductList[i].DiscountAmt,//edt_final_disc_perAmount.text.toString()=="null"?"0.00":double.parse(edt_final_disc_perAmount.text.toString())/TempproductList.length,
        ...
        pkID:0,//TempproductList[i].pkID,
        LoginUserID:LoginUserID,
        CompanyId:CompanyID.toString(),
        BundleId:TempproductList[i].BundleId,
        HeaderDiscAmt:TempproductList[i].HeaderDiscAmt,//edt_HeaderDisc.text.toString()=="null"?0.00:double.parse(edt_HeaderDisc.text.toString()),
        AdditionalDiscAmt:"0.00",//edt_final_additional_disc_perAmount.text.toString()=="null"?"0.00":double.parse(edt_final_additional_disc_perAmount.text.toString())/TempproductList.length,
        ProfitAmount:"0.00",
        SubsidyApplicable:"0",
        Flag:"0",
        OthRef1:"0",
    ...
    _inquiryBloc.add(QuotationProductSaveCallEvent(
        context1, ReturnQT_No.replaceAll("/", "-"), arrNewQuotationProductTable));
  }
  ...
  void _onOtherChargeListResponse(QuotationOtherChargeListResponseState state) {
    ...
    i++) {
      if(_editModel.chargeID1==state.quotationOtherChargesListResponse.details[i].pkId)
      {
        ChargeTaxType1 = state.quotationOtherChargesListResponse.details[i].taxType;
        ChargeGstPer1 = state.quotationOtherChargesListResponse.details[i].gSTPer;
        ChargeIsBeforGst1 = state.quotationOtherChargesListResponse.details[i].beforeGST;

      }
      if(_editModel.chargeID2==state.quotationOtherChargesListResponse.details[i].pkId)
      {
        ChargeTaxType2 = state.quotationOtherChargesListResponse.details[i].taxType;
        ChargeGstPer2 = state.quotationOtherChargesListResponse.details[i].gSTPer;
        ChargeIsBeforGst2 = state.quotationOtherChargesListResponse.details[i].beforeGST;

      }

      if(_editModel.chargeID3==state.quotationOtherChargesListResponse.details[i].pkId)
      {
        ChargeTaxType3 = state.quotationOtherChargesListResponse.details[i].taxType;
        ChargeGstPer3= state.quotationOtherChargesListResponse.details[i].gSTPer;
        ChargeIsBeforGst3 = state.quotationOtherChargesListResponse.details[i].beforeGST;

      }

      if(_editModel.chargeID4==state.quotationOtherChargesListResponse.details[i].pkId)
      {
        ChargeTaxType4 = state.quotationOtherChargesListResponse.details[i].taxType;
        ChargeGstPer4 = state.quotationOtherChargesListResponse.details[i].gSTPer;
        ChargeIsBeforGst4 = state.quotationOtherChargesListResponse.details[i].beforeGST;

      }
      if(_editModel.chargeID5==state.quotationOtherChargesListResponse.details[i].pkId)
      {
        ChargeTaxType5 = state.quotationOtherChargesListResponse.details[i].taxType;
        ChargeGstPer5 = state.quotationOtherChargesListResponse.details[i].gSTPer;
        ChargeIsBeforGst5 = state.quotationOtherChargesListResponse.details[i].beforeGST;
    ...
    double totgsttemp = _editModel.cGSTAmt + _editModel.sGSTAmt+ _editModel.iGSTAmt;
    addditionalCharges = AddditionalCharges(
        DiscountAmt: _editModel.discountAmt.toString(),
        SGSTAmt: _editModel.sGSTAmt.toString(),
        CGSTAmt: _editModel.cGSTAmt.toString(),
    ...
    print("ChargeTaxType1__" + "ChargeTaxType1 : "+ ChargeTaxType1.toString() + "ChargeTaxType2 : "+
        ChargeTaxType2.toString() + " ChargeTaxType3 : "+ ChargeTaxType3.toString() + " ChargeTaxType4 : "+ ChargeTaxType4.toString()
        + " ChargeTaxType5 "+ ChargeTaxType5.toString());
    print("ChargeIsBeforGst1_" + " ChargeIsBeforGst1 : "+ ChargeIsBeforGst1.toString() + " ChargeIsBeforGst2 : "+ ChargeIsBeforGst2.toString() + " ChargeIsBeforGst3 : "+ ChargeIsBeforGst3.toString() + " ChargeIsBeforGst4 : "+ ChargeIsBeforGst4.toString() + " ChargeIsBeforGst5 : "+ ChargeIsBeforGst5.toString());
...
/*
  ...
  List<double> UpdateHeaderDiscountCalculation(
    ...
    if (tempproductList != null) {
      ...
      _otherChargeIDController1 =
          addditionalCharges.ChargeID1;
      _otherChargeIDController2 =
          addditionalCharges.ChargeID2;
      _otherChargeIDController3 =
          addditionalCharges.ChargeID3;
      _otherChargeIDController4 =
          addditionalCharges.ChargeID4;
      _otherChargeIDController5 =
          addditionalCharges.ChargeID5;

      _otherChargeNameController1 =
          addditionalCharges.ChargeName1;
      _otherChargeNameController2 =
          addditionalCharges.ChargeName2;
      _otherChargeNameController3 =
          addditionalCharges.ChargeName3;
      _otherChargeNameController4 =
          addditionalCharges.ChargeName4;
      _otherChargeNameController5 =
          addditionalCharges.ChargeName5;
     ...
     /* HeaderDisAmnt = edt_HeaderDisc.text.isNotEmpty
          ? double.parse(edt_HeaderDisc.text)
          : 0.00;*/
      HeaderDisAmnt = addditionalCharges.DiscountAmt.isNotEmpty?double.parse(addditionalCharges.DiscountAmt):0.00;
  ...
  List<double> UpdateHeaderDiscountCalculationNew(List<QuotationTable> tempproductList) {
    if (tempproductList != null) {
      ...
      addditionalCharges = AddditionalCharges(
          ...
          OtherChargeWithExcludTax:Tot_otherChargeExcludeTax.toStringAsFixed(2),
                    ...
                    Container(
                      ...
                      child: getCommonButton(baseTheme, () async {
                        if (edt_CustomerName.text != "") {
                          ...
                          navigateTo(context,
                              OldGreenEdgeQuotationProductListScreen.routeName,
                                  arguments: OldGreenEdgeQuotationProductListScreenArgument(
                                      InquiryNo,
                                      edt_StateCode.text,
                                      edt_HeaderDisc.text))
                              .then((value) async {
