...
class PackingChecklistAddScreen extends BaseStatefulWidget {
  ...
  @override
  _PackingChecklistAddScreenState createState() =>
      _PackingChecklistAddScreenState();
}
...
class _PackingChecklistAddScreenState
  ...
  final TextEditingController edt_Packing_List_Date_Reverse =
      TextEditingController();

  final TextEditingController edt_Machine_Finalize_date =
      TextEditingController();
  final TextEditingController edt_Machine_Finalize_dateReverse =
      TextEditingController();

  final TextEditingController edt_Machine_Dispatch_date =
      TextEditingController();
  final TextEditingController edt_Machine_Dispatch_dateReverse =
      TextEditingController();
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        CustomDropDown1("SO No.",
                            ...
                            Custom_values1: arr_ALL_Name_ID_For_OutWordList),
                        _isForUpdate == true
                            ? Column(
                                children: [
                                  SizedBox(
                          ...
                          child: getCommonButton(baseTheme, () async {
                            ...
                            if (edt_S_O_No.text != "") {
                              ...
                              if (_isForUpdate == true) {
                                navigateTo(context,
                                    PackingAssamblyListScreen.routeName,
                                    arguments: AddPackingAssamblyListArgument(
                              ...
                              showCommonDialogWithSingleOption(context,
                                  "So No Is Required To Add Product Assembly!",
  ...
  Widget QualifiedCountry() {
    return Column(
      ...
      children: [
        ...
        InkWell(
            onTap: () {
              _onTapOfSearchCountryView(_searchCountryDetails == null
                  ? ""
  ...
  Widget QualifiedState() {
    return InkWell(
      onTap: () {
        _onTapOfSearchStateView(_searchCountryDetails == null
            ? ""
            : _searchCountryDetails.countryCode);
      },
      child: Column(
              ...
              if (_isForUpdate != true) {
                if (edt_CustomerName.text != "") {
                  if (arr_ALL_Name_ID_For_OutWordList.length != 0) {
                    ...
                    showCommonDialogWithSingleOption(context,
                        " Enter Valid Customer Name Which have Created SalesOrder !",
...
*/
          ...
          packingChecklistBloc.add(OutWordCallEvent(OutWordNoListRequest(
        ...
        if (edt_S_O_No.text != "") {
          if (edt_Machine_Finalize_date.text != "") {
            if (edt_Machine_Dispatch_date.text != "") {
                ...
                if (edt_State_Name.text != "") {
                  if (edt_City_Name.text != "") {
                    print("SaveRequest" +
                        ...
                        "0" +
                        " PCdate : " +
                        edt_Packing_List_Date_Reverse.text +
                        " FinalizeDate : " +
                    ...
                    showCommonDialogWithTwoOptions(context,
                        "Are you sure you want to Save this Packing CheckList ?",
                        negativeButtonTitle: "No",
                        positiveButtonTitle: "Yes", onTapOfPositiveButton: () {
                      Navigator.of(context).pop();

                      if (edt_PackingNo.text != "") {
                        packingChecklistBloc.add(
                            DeleteALLPackingAssamblyCallEvent(
                                edt_PackingNo.text,
                                DeleteAllPakingAssamblyRequest(
                                    CompanyId: CompanyID.toString())));
                      }
                      ...
                      packingChecklistBloc.add(PackingSaveCallEvent(
                          ...
                          PackingSaveRequest(
                              ...
                              EmployeeID: edt_EmployeeID.text == null
                                  ? ""
                                  : edt_EmployeeID.text,
                              PCdate: edt_Packing_List_Date_Reverse.text == null
                                  ? ""
                                  : edt_Packing_List_Date_Reverse.text,
                              FinalizeDate:
                                  edt_Machine_Finalize_dateReverse.text == null
                                      ? ""
                                      : edt_Machine_Finalize_dateReverse.text,
                              DispatchDate:
                                  edt_Machine_Dispatch_dateReverse.text == null
                                      ? ""
                                      : edt_Machine_Dispatch_dateReverse.text,
                              ...
                              FinishProductID: edt_FinishProductID.text == null
                                  ? ""
                                  : edt_FinishProductID.text,
                              Application: edt_Application.text == null ? "" : edt_Application.text,
              ...
              showCommonDialogWithSingleOption(
                  context, "Machine Dispatch date is required !",
                  positiveButtonTitle: "OK");
            }
          } else {
            showCommonDialogWithSingleOption(
                context, "Machine Finalize date is required !",
                positiveButtonTitle: "OK");
          }
        } else {
  ...
  void _onOutWordResponse(OutWordResponseState state1) {
    if (state1.outWordNoListResponse.details.length != 0) {
      ...
      showCommonDialogWithSingleOption(
          context, " Enter Valid Customer Name Which have Created SalesOrder !",
          positiveButtonTitle: "OK", onTapOfPositiveButton: () {
        Navigator.pop(context);
      });
    }
    print("ResponseOf OutWord" +
        " Details : " +
        state1.outWordNoListResponse.details[0].productName);
  }

  void _onpackingAssamblyResponse(
      PackingProductAssamblyListResponseState state) async {
    ...
    if (edt_FinishProductID.text != "") {
      for (int i = 0;
          i < state.packingProductAssamblyListResponse.details.length;
          i++) {
        int finishProductID =
            state.packingProductAssamblyListResponse.details[i].finishProductID;
        String finishProductName = state
            .packingProductAssamblyListResponse.details[i].finishProductName;
        int productGroupID =
            state.packingProductAssamblyListResponse.details[i].productGroupID;
        String productGroupName = state
            .packingProductAssamblyListResponse.details[i].productGroupName;
        int productID =
            state.packingProductAssamblyListResponse.details[i].productID;
        String productName =
            state.packingProductAssamblyListResponse.details[i].productName;
        String unit = state.packingProductAssamblyListResponse.details[i].unit;
        double quantity =
            state.packingProductAssamblyListResponse.details[i].quantity;
        String ProductSpecification = "";
  ...
  void fillData() async {
    ...
    edt_Machine_Finalize_date.text = _editModel.finalizeDate.getFormattedDate(
        fromFormat: "yyyy-MM-ddTHH:mm:ss", toFormat: "dd-MM-yyyy");
    edt_Machine_Finalize_dateReverse.text = _editModel.finalizeDate
        .getFormattedDate(
            fromFormat: "yyyy-MM-ddTHH:mm:ss", toFormat: "yyyy-MM-dd");
    edt_Machine_Dispatch_date.text = _editModel.dispatchDate.getFormattedDate(
        fromFormat: "yyyy-MM-ddTHH:mm:ss", toFormat: "dd-MM-yyyy");
    edt_Machine_Dispatch_dateReverse.text = _editModel.dispatchDate
        .getFormattedDate(
            fromFormat: "yyyy-MM-ddTHH:mm:ss", toFormat: "yyyy-MM-dd");
    ...
    edt_EmployeeName.text =
        _editModel.employeeName.toString() == "--Not Available--"
            ? ""
            : _editModel.employeeName.toString();
    edt_EmployeeID.text = _editModel.employeeID.toString();

    await OfflineDbHelper.getInstance().deleteALLPackingProductAssambly();

    packingChecklistBloc.add(PackingAssamblyEditModeRequestCallEvent(
        PackingAssamblyEditModeRequest(
            PCNo: _editModel.pCNo, CompanyId: CompanyID.toString())));
  ...
  void _onFollowerEmployeeListByStatusCallSuccess(
      ALL_EmployeeList_Response offlineFollowerEmployeeListData1) {
    arr_ALL_Name_ID_For_Folowup_EmplyeeList.clear();

    if (offlineFollowerEmployeeListData1.details != null) {
      for (var i = 0;
          i < offlineFollowerEmployeeListData1.details.length;
          i++) {
        ALL_Name_ID all_name_id = ALL_Name_ID();
        all_name_id.Name =
            offlineFollowerEmployeeListData1.details[i].employeeName;
  ...
  void updateRetrunInquiryNoToDB(String ReturnInquiryNo) {
    _inquiryProductList.forEach((element) {
      element.FinishProductID = int.parse(
          edt_FinishProductID.text == "" ? 0 : edt_FinishProductID.text);
  ...
  void _onPackingAssamblySaveResponse(
      PackingAssamblySaveResponseState state) async {
    ...
    await showCommonDialogWithSingleOption(
        Globals.context, state.packingAssamblySaveResponse.details[0].column2,
        positiveButtonTitle: "OK");
    Navigator.of(context).pop();
  }

  void _OnDeleteAllAssamblyResponse(
      DeleteAllPackingAssamblyResponseState state) {
    print("DeleteAllAssamblyResponse" +
        state.delete_all_assambly_response.details[0].column1.toString());
  }

  void _OnPackingAssamblyEditMode(
      PackingAssamblyEditModeResponseState state) async {
    int finishProductID = 0;
    String finishProductName = "";
    int productGroupID = 0;
    String productGroupName = "";
    ...
    for (int i = 0;
        i < state.packingAssamblyEditModeResponse.details.length;
        i++) {
      productGroupID =
          state.packingAssamblyEditModeResponse.details[i].productGroupID;
      productGroupName =
          state.packingAssamblyEditModeResponse.details[i].productGroupName;
      productID = state.packingAssamblyEditModeResponse.details[i].productID;
      productName =
          state.packingAssamblyEditModeResponse.details[i].productName;
      ...
      ProductSpecification =
          state.packingAssamblyEditModeResponse.details[i].productSpecification;
                              ...
                              return InkWell(
                                onTap: () async {
                                  ...
                                  await OfflineDbHelper.getInstance()
                                      .deleteALLPackingProductAssambly();
                                  packingChecklistBloc.add(
                                      PackingProductAssamblyListRequestCallEvent(
                                          PackingProductAssamblyListRequest(
                                              ProductID:
                                                  values[index].pkID.toString(),
                                              CompanyId:
                                                  CompanyID.toString())));
