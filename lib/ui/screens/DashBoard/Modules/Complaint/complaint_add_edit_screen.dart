...
class _ComplaintAddEditScreenState extends BaseState<ComplaintAddEditScreen>
    ...
    return BlocProvider(
      ...
      child: BlocConsumer<ComplaintScreenBloc, ComplaintScreenStates>(
        ...
        listener: (BuildContext context, ComplaintScreenStates state) {
          ...
          if (state is CustomerTypeCallEventResponseState) {
            _onLeadTypeListTypeCallSuccess(state);
          }
        ...
        listenWhen: (oldState, currentState) {
          if (currentState is CustomerSourceCallEventResponseState ||currentState is CustomerTypeCallEventResponseState||
                  ...
                  child: Column(
                    children: [
                      Column(
                        ...
                        }, "Save", backGroundColor: colorPrimary, radius: 10, textColor: Colors.white, textSize: 20),
                        SizedBox(
                          width: 20,
                          height: 15,
                        ),
  ...
  Widget CustomDropDown1(String Category,
    ...
    return Container(
      ...
      child: Column(
        children: [
          InkWell(
            onTap: () => _complaintScreenBloc.add(CustomerTypeCallEvent(
                CustomerSourceRequest(
                    pkID: "0",
                    StatusCategory: "ComplaintType",
                    companyId: CompanyID,
                    LoginUserID: LoginUserID,
                    SearchKey: ""))),
            child: Column(
  ...
  Widget showCustomType(String Category,
      {bool enable1,
        Icon icon,
        String title,
        String hintTextvalue,
  ...
  void _onLeadTypeListTypeCallSuccess(
      CustomerTypeCallEventResponseState state) {
    if (state.sourceResponse.details.length != 0) {
