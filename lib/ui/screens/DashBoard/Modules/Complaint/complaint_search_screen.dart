...
class SearchComplaintScreen extends BaseStatefulWidget {
  ...
  @override
  _SearchComplaintScreenState createState() => _SearchComplaintScreenState();
}

class _SearchComplaintScreenState extends BaseState<SearchComplaintScreen>
    with BasicScreen, WidgetsBindingObserver {
  ComplaintScreenBloc _CustomerBloc;
  ...
  void initState() {
    ...
    _CustomerBloc = ComplaintScreenBloc(baseBloc);
  }
