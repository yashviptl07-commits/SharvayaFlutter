...
class MaterialOutwardDetailsAddEditScreenArguments {
  MaterialOutwardTable model;
  int StateCode;
  String OutwardNo;

  MaterialOutwardDetailsAddEditScreenArguments(
      this.model, this.StateCode, this.OutwardNo);
}

class MaterialOutwardDetailsAddEditScreen extends BaseStatefulWidget {
  static const routeName = '/MaterialOutwardDetailsAddEditScreen';
  final MaterialOutwardDetailsAddEditScreenArguments arguments;

  MaterialOutwardDetailsAddEditScreen(this.arguments);

  @override
  _MaterialOutwardDetailsAddEditScreenState createState() =>
      _MaterialOutwardDetailsAddEditScreenState();
}

class _MaterialOutwardDetailsAddEditScreenState
    extends BaseState<MaterialOutwardDetailsAddEditScreen>
  ...
  List<MaterialOutwardTable> _inquiryProductList = [];
  ...
  _onTapOfAdd() async {
    ...
    if (isProductExist == false) {
      if (isForUpdate) {
        await OfflineDbHelper.getInstance().updateMaterialOutwardProduct(
            MaterialOutwardTable(
                ...
                disc, //double DiscountPercent,
                netRate, //double NetRate,
                amount, //double Amount,
                taxPer, //double TaxRate,
                taxAmount, //double TaxAmount,
                netAmount, //double NetAmount,
                widget.arguments.model.OrderNo == ""
                    ? ""
                    : widget.arguments.model.OrderNo, //String OrderNo,
                0, //int LocationID,
                ...
                quantity, //double SampleQuantity,
