    ...
    if (service is AndroidServiceInstance) {
      if (await service.isForegroundService()) {
        ...
        if (reminders.isNotEmpty) {
          print("Reminders fetched: ${reminders.length}. Sending notifications...");
          print(reminders);
        } else {
        ...
        for (var reminder in reminders) {
          ...
          await BackgroundService().sendFirebaseNotification(
            reminder['title'],
            reminder['body'],
            reminder['tokens'],
          );
...
class BackgroundService {
  ...
  Future<List<Map<String, dynamic>>> fetchTaskReminderList() async {
    final String apiUrl = 'http://192.168.1.10:130/Dashboard/TaskReminderList';
  ...
  Future<String> getAccessToken() async {
    ...
    final serviceAccountJson = {
      ...
      "client_x509_cert_url": "https://www.googleapis.com/robot/v1/metadata/x509/e-office-desk-flutter%40appspot.gserviceaccount.com",
