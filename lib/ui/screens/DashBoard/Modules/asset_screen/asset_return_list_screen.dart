...
class AssetReturnListScreen extends BaseStatefulWidget {
  static const routeName = '/AssetReturnListScreen';

  @override
  _AssetReturnListScreenState createState() => _AssetReturnListScreenState();
}

class _AssetReturnListScreenState extends BaseState<AssetReturnListScreen>
    with BasicScreen, WidgetsBindingObserver {
  MainBloc _mainBloc;
  int _pageNo = 0;
  AssetReturnListResponse _listResponse;
    ...
    return BlocProvider(
      ...
      child: BlocConsumer<MainBloc, MainStates>(
        builder: (BuildContext context, MainStates state) {
          if (state is AssetReturnListCallResponseState) {
            _onAssetReturnListCallResponseStateSuccess(state);
          }
          return super.build(context);
        },
        buildWhen: (oldState, currentState) {
          if (currentState is AssetReturnListCallResponseState) {
            return true;
          }
          return false;
        },
  ...
  void _onAssetReturnListCallResponseStateSuccess(
      AssetReturnListCallResponseState state) {
