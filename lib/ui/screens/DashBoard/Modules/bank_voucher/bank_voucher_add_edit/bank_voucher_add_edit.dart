    ...
    return BlocProvider(
      ...
      child: BlocConsumer<BankVoucherScreenBloc, BankVoucherScreenStates>(
        ...
        listenWhen: (oldState, currentState) {
          if (currentState is TransectionModeResponseState ||
              currentState is BankDropDownResponseState ||
              currentState is BankVoucherSaveResponseState) {
            return true;
          }
          return false;
        },
                          ...
                          if (edt_CustomerName.text != "") {
                            if (edt_TransectionMode_Name.text != "") {
                              if (edt_NextFollowupDate.text != "") {
                                if (edt_FollowupNotes.text != "") {
                                  ...
                                  if (FbrazilianDate.isBefore(NbrazilianDate)) {
                                    showCommonDialogWithTwoOptions(context,
                                      ...
                                      _FollowupBloc.add(BankVoucherSaveCallEvent(
                                          context,
                                          savepkID,
                                          BankVoucherSaveRequest(
                                              ...
                                              TransID:
                                                  edt_CheqNo_details.text == null
                                                      ? ""
                                                      : edt_CheqNo_details.text,
                                              TransDate:
                                                  edt_ReverseNextFollowupDate
                                                      .text,
                                              VoucherAmount:
                                                  edt_Voucher_Amount.text == null
                                                      ? ""
                                                      : edt_Voucher_Amount.text,
                                              BankName:
                                                  edt_Portal_details.text == null
                                                      ? ""
                                                      : edt_Portal_details.text,
                                              Remark: edt_FollowupNotes.text,
                                              BasicAmt: "0.00",
                                              NetAmt: "0.00",
                                    ...
                                    if (FbrazilianDate.isAtSameMomentAs(
                                        ...
                                        _FollowupBloc.add(BankVoucherSaveCallEvent(
                                            ...
                                            BankVoucherSaveRequest(
                                                ...
                                                RecPay: edt_Priority.text == null
                                                    ...
                                                    : edt_Priority.text,
                                                VoucherNo: "",
                                                VoucherDate: edt_ReverseFollowUpDate
                                                    .text,
                                                AccountID:
                                                    edt_Bank_A_C_ID.text == null
                                                        ? ""
                                                ...
                                                TransModeID:
                                                    edt_TransectionMode_ID.text,
                                                TransID: edt_CheqNo_details.text == null
                                                    ? ""
                                                    : edt_CheqNo_details.text,
                                                TransDate:
                                                    edt_ReverseNextFollowupDate
                                                ...
                                                VoucherAmount:
                                                    edt_Voucher_Amount.text == null
                                                        ...
                                                        : edt_Voucher_Amount
                                                            .text,
                                                BankName: edt_Portal_details.text == null
                                                    ? ""
                                                    : edt_Portal_details.text,
                                                Remark: edt_FollowupNotes.text,
                                                BasicAmt: "0.00",
                                      ...
                                      showCommonDialogWithSingleOption(context,
                                          "Transaction Date/Cheque Date Should be greater than Voucher Date !",
                                ...
                                showCommonDialogWithSingleOption(context,
                                    "Transaction Date/Cheque Date is Required!",
                                    positiveButtonTitle: "OK",
                                    onTapOfPositiveButton: () {
                                  Navigator.of(context).pop();
                                });
  ...
  void fillData() {
    ...
    if (_editModel.transDate == "") {
      ...
      edt_NextFollowupDate.text = _editModel.transDate.getFormattedDate(
          fromFormat: "yyyy-MM-ddTHH:mm:ss", toFormat: "dd-MM-yyyy");
      edt_ReverseNextFollowupDate.text = _editModel.transDate.getFormattedDate(
          fromFormat: "yyyy-MM-ddTHH:mm:ss", toFormat: "yyyy-MM-dd");
    }
    ...
    return Container(
      child: Column(
        children: [
          InkWell(
            onTap: () => _FollowupBloc
              ..add(BankDropDownCallEvent(BankDropDownRequest(
                  CompanyID: CompanyID.toString(),
  ...
  void _onBankVoucherSaveResponse(BankVoucherSaveResponseState state) async {
    ...
    for (var i = 0; i < state.bankVoucherSaveResponse.details.length; i++) {
      ...
      Msg = _isForUpdate == true
          ? "Voucher Transaction. Updated Successfully"
          : "Voucher Transaction. Added Successfully";
    }
