...
class _SearchBankVoucherScreenState extends BaseState<SearchBankVoucherScreen>
  ...
  BankVoucherSearchByNameResponse _searchCustomerListResponse;
    ...
    return BlocProvider(
      ...
      child: BlocConsumer<BankVoucherScreenBloc, BankVoucherScreenStates>(
        builder: (BuildContext context, BankVoucherScreenStates state) {
          if (state is BankVoucherSearchByNameCallResponseState) {
            _onSearchInquiryListCallSuccess(state);
          }
          return super.build(context);
        },
        buildWhen: (oldState, currentState) {
          if (currentState is BankVoucherSearchByNameCallResponseState) {
            return true;
          }
          return false;
        },
  ...
  void _onSearchInquiryListCallSuccess(
      BankVoucherSearchByNameCallResponseState state) {
