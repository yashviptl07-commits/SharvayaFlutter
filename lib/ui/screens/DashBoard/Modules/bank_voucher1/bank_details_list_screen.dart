...
class MaintenanceDetailsListScreenArgument {
  int PkID;
  int CustomerId;

  MaintenanceDetailsListScreenArgument(this.PkID, this.CustomerId);
}

class MaintenanceDetailsListScreen extends BaseStatefulWidget {
  static const routeName = '/MaintenanceDetailsListScreen';
  final MaintenanceDetailsListScreenArgument arguments;
  MaintenanceDetailsListScreen(this.arguments);
  @override
  _MaintenanceDetailsListScreenState createState() =>
      _MaintenanceDetailsListScreenState();
}

class _MaintenanceDetailsListScreenState
    extends BaseState<MaintenanceDetailsListScreen>
              ...
              children: [
                ...
                Container(
                  ...
                  child: FloatingActionButton(
                    ...
                    onPressed: () {
                      navigateTo(context, AddMaintenanceDetailsScreen.routeName,
                              arguments: AddMaintenanceDetailsScreenArguments(
                                  pkId, CustomerId))
                          .then((value) {
                        getProduct();
                      });
