...
class SearchCountryForGreenEdgeScreenArguments {
  String model123;

  SearchCountryForGreenEdgeScreenArguments(this.model123);
}

class SearchCountryForGreenEdgeScreen extends BaseStatefulWidget {
  static const routeName = '/SearchCountryForGreenEdgeScreen';
  final SearchCountryForGreenEdgeScreenArguments arguments;

  SearchCountryForGreenEdgeScreen(this.arguments);

  @override
  _SearchCountryForGreenEdgeScreenState createState() => _SearchCountryForGreenEdgeScreenState();
}

class _SearchCountryForGreenEdgeScreenState extends BaseState<SearchCountryForGreenEdgeScreen>
  ...
  Widget buildBody(BuildContext context) {
    return Column(
      children: [
        NewGradientAppBar(
          title: Text('Search Country Hello'),
  ...
  void _onSearchInquiryListCallSuccess(CountryListEventResponseState state) {
