...
class TeleCallerNewListScreen extends BaseStatefulWidget {
  ...
  @override
  _TeleCallerNewListScreenState createState() =>
      _TeleCallerNewListScreenState();
}
...
class _TeleCallerNewListScreenState extends BaseState<TeleCallerNewListScreen>
  ...
  void initState() {
    ...
    teleCallerNewBloc.add(TeleCallerNewListCallEvent(
        1,
      ...
      if (edt_SearchCustomer.text.length > 2) {
        teleCallerNewBloc.add(TeleCallerNewListCallEvent(
            ...
            TeleCallerNewListRequest(
                ...
                SearchKey: edt_SearchCustomer.text,
                CompanyId: CompanyID.toString(),
                LoginUserID: LoginUserID,
                LeadStatus: edt_LeadStatus.text == "ALL Leads"
                    ? ""
  ...
  void _onTelecallerNewpaginationCallSuccess(
      TeleCallerNewListCallResponseState state) {
  ...
  void _onTapOfDeleteCustomer(int id) {
    showCommonDialogWithTwoOptions(
      ...
      //_collapse();
      teleCallerNewBloc.add(TeleCallerDeleteCallEvent(
...
/*
  ...
  void _onDeleteLead(
      BuildContext buildContext123, TeleCallerDeleteCallResponseState state) {
