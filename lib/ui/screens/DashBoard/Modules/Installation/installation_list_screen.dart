...
class _InstallationListScreenState extends BaseState<InstallationListScreen>
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  Expanded(
                    child: Text(
                      SD == null ? "Tap to search customer" : SD.label,
                      style: baseTheme.textTheme.headline3.copyWith(
                          color: SD == null ? colorGrayDark : colorBlack),
                    ),
                  ),
                  Icon(
                    Icons.search,
  ...
  void _onTapOfDeleteInquiry(
      DeleteInstallationCallResponseState state, BuildContext context) {
