...
class GeneralFollowupListForAlmightyScreenArguments {
  String EmployeeName;
  GeneralFollowupListForAlmightyScreenArguments(this.EmployeeName);
}

class GeneralFollowupListForAlmightyScreen extends BaseStatefulWidget {
  static const routeName = '/GeneralFollowupListForAlmightyScreen';
  final GeneralFollowupListForAlmightyScreenArguments arguments;

  GeneralFollowupListForAlmightyScreen(this.arguments);

  @override
  _GeneralFollowupListForAlmightyScreenState createState() =>
      _GeneralFollowupListForAlmightyScreenState();
}

class _GeneralFollowupListForAlmightyScreenState
    extends BaseState<GeneralFollowupListForAlmightyScreen>
  ...
  final TextEditingController edt_FollowupEmployeeUserID =
      TextEditingController();
  final TextEditingController edt_SearchController = TextEditingController();
  ...
  void dispose() {
    ...
    edt_SearchController.dispose();
    super.dispose();
  }

  void _fetchList() {
    _FollowupBloc.add(FollowupFilterForAlmightyListCallEvent(
  ...
  void _fetchCount() {
    _FollowupBloc.add(FollowupCountForAlmightyRequestEvent(
        _selectedFilterStatus,
  ...
  void _onSearchChanged(String value) {
    ...
    _debounceTimer = Timer(const Duration(milliseconds: 500), () {
      setState(() {
        ...
        _pageNo = 0; // Reset page number for new search
      });
      _fetchList();
      _fetchCount();
    });
  ...
  void _onStatusChipTapped(String status) {
    ...
    setState(() {
      ...
      _pageNo = 0; // Reset page number when changing filter
    });
    _fetchList();
    _fetchCount();
  }
  ...
  void _onEmployeeFilterTap() {
    showcustomdialog(
        ...
        onValueSelected: () {
          setState(() {
            _selectedEmployeeID = edt_FollowupEmployeeUserID.text;
            _pageNo = 0; // Reset page number when changing employee
          });
          _fetchList();
          _fetchCount();
        });
                ...
                onPressed: () {
                  navigateTo(context, FollowUpAddEditScreen.routeName,
                      arguments: AddUpdateFollowupScreenArguments(
                          null, _selectedFilterStatus, "Almighty"));
                },
              ),
            IconButton(
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              Expanded(
                child: TextField(
                  controller: edt_SearchController,
              ...
              if (_searchKey.isNotEmpty && _debounceTimer?.isActive == true)
                SizedBox(
                  width: r.s(16),
                  height: r.s(16),
            ...
            children: [
              ...
              Text(
                _searchKey.isNotEmpty
                    ? "No results found for \"$_searchKey\""
                    : "No Followups Found",
                style: TextStyle(
                    fontSize: r.f(14),
  ...
  void _navigateToFollowUp(FilterDetails model) {
    ...
    navigateTo(context, FollowUpAddEditScreen.routeName,
            arguments: AddUpdateFollowupScreenArguments(
                model, _selectedFilterStatus, "Almighty"))
        .then((value) {
      setState(() {
