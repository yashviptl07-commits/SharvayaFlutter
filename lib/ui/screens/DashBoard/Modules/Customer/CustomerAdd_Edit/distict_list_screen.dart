...
class _SearchDistrictScreen extends BaseState<SearchDistrictScreen>
    ...
    if (widget.arguments != null) {
      ...
      _CustomerBloc
        ..add(DistrictCallEvent(DistrictApiRequest(
            ...
            StateCode: widget.arguments.statecode)));
    }
  }
  ...
  void _onSearchInquiryListCallSuccess(DistrictListEventResponseState state) {
    ...
    for (var i = 0; i < state.districtApiResponseList.details.length; i++) {
      print("CustomerCategoryResponse2 : " +
          state.districtApiResponseList.details[i].districtName);
      ALL_Name_ID categoryResponse123 = ALL_Name_ID();
      categoryResponse123.Name =
          state.districtApiResponseList.details[i].districtName;
      categoryResponse123.pkID =
          state.districtApiResponseList.details[i].districtCode;
