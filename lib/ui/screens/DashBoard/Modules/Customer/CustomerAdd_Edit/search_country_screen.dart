...
class CountryArguments {
  ...
  CountryArguments(this.model123);
}

class SearchCountryScreen extends BaseStatefulWidget {
  static const routeName = '/SearchCountryScreen';
  final CountryArguments arguments;

  SearchCountryScreen(this.arguments);

  @override
  _SearchCountryScreen createState() => _SearchCountryScreen();
}

class _SearchCountryScreen extends BaseState<SearchCountryScreen>
