...
class SBAddEditScreenArguments {
  SaleBillTable model;
  int StateCode;
  String HeaderDiscAmnt;
  String QuotationNo;

  SBAddEditScreenArguments(
...
class SBAddEditScreen extends BaseStatefulWidget {
  static const routeName = '/SBAddEditScreen';
  final SBAddEditScreenArguments arguments;

  SBAddEditScreen(this.arguments);

  @override
  _SBAddEditScreenState createState() => _SBAddEditScreenState();
}

class _SBAddEditScreenState extends BaseState<SBAddEditScreen>
    ...
    return Column(
      children: [
        getCommonAppBar(context, baseTheme,
            "${isForUpdate ? "Update" : "Add"} SalesBill Product",
                            ...
                            children: [
                              ...
                              Expanded(
                                child: getCommonButton(baseTheme, () async {
                                  ...
                                  navigateTo(
                                          context, SBAssemblyScreen.routeName,
                                          arguments: SBAssemblyScreenArgument(
                                              _QuotationNo,
                                              _productIDController.text
                                                  .toString()))
                                      .then((value) {
...
*/
  ...
  _onTapOfAdd() async {
    ...
    if (isProductExist == false) {
      if (isForUpdate) {
        await OfflineDbHelper.getInstance().updateSalesBillProduct(
            SaleBillTable(
                "",
                Specification,
                productID,
