...
class DolphinComplaintVisitListScreen extends BaseStatefulWidget {
  ...
  @override
  _DolphinComplaintVisitListScreenState createState() =>
      _DolphinComplaintVisitListScreenState();
}

class _DolphinComplaintVisitListScreenState
    extends BaseState<DolphinComplaintVisitListScreen>
  ...
  void initState() {
    ...
    _expenseBloc
      ..add(DolphinComplaintVisitListCallEvent(
          1,
          DolphinComplaintVisitListRequest(
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      //_expenseBloc..add(ExpenseEventsListCallEvent(1,ExpenseListAPIRequest(CompanyId: CompanyID.toString(),LoginUserID: edt_FollowupEmployeeUserID.text,word: edt_FollowupStatus.text,needALL: "0"))),
      child:
          BlocConsumer<DolphinComplaintVisitBloc, DolphinComplaintVisitStates>(
        ...
        buildWhen: (oldState, currentState) {
          if (currentState
              is DolphinComplaintVisitListCallResponseState /*|| currentState is ExternalLeadSearchByIDResponseState*/) {
            return true;
          }
          return false;
        },
  ...
  void _onInquiryListCallSuccess(
      DolphinComplaintVisitListCallResponseState state) {
  ...
  ExpantionCustomer(BuildContext context, int index) {
    ...
    return Container(
        ...
        child: ExpansionTileCard(
          ...
          title: Text(
            _expenseListResponse.details[index].customerName,
            style: TextStyle(color: Colors.black),
          ),
          subtitle: Text(
            _expenseListResponse.details[index].complaintNoString,
            style: TextStyle(
...
*/
  ...
  void _onExpenseRequestDeleteCallSucess(
      DolphinComplaintVisitDeleteResponseState state,
      BuildContext buildContext123) {
...
*/
  ...
  void _onTapOfDeleteCustomer(int pkID) {
    showCommonDialogWithTwoOptions(
      ...
      Navigator.of(context).pop();
      //_collapse();
      _expenseBloc.add(DolphinComplaintVisitDeleteCallEvent(
          DolphinComplaintVisitDeleteRequest(
              CompanyID: CompanyID.toString(), pkID: pkID.toString())));
    });
  }
