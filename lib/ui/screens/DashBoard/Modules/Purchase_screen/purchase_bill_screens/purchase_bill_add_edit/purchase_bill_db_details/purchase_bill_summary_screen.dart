...
class NewPurchaseBillOtherChargeScreenArguments {
  int StateCode;
  ...
  NewPurchaseBillOtherChargeScreenArguments(
      this.StateCode,
      this.editModel,
...
class NewPurchaseBillOtherChargeScreen extends BaseStatefulWidget {
  static const routeName = '/NewPurchaseBillOtherChargeScreen';
  final NewPurchaseBillOtherChargeScreenArguments arguments;

  NewPurchaseBillOtherChargeScreen(this.arguments);

  @override
  _NewPurchaseBillOtherChargeScreenState createState() =>
      _NewPurchaseBillOtherChargeScreenState();
}

class _NewPurchaseBillOtherChargeScreenState
    extends BaseState<NewPurchaseBillOtherChargeScreen>
  ...
  List<PurchaseBillTable> productList = [];
  ...
  void _OnGetQuotationProductList(GetPBProductListState state) {
    if (state.response != null) {
      ...
      for (int i = 0; i < productList.length; i++) {
        print("productList" +
            ...
            productList[i].DiscountPer.toString() +
  ...
  void _OnTaptoSave() {
    ...
    if (productList != null) {
      ...
      _mainBloc.add(InsertPBProductEvent(TempproductList));
  ...
  void UpdatefromaddeditScreen(List<PurchaseBillTable> tempproductList) {
    if (tempproductList != null) {
      double Tot_BasicAmount = 0.00;
      double Tot_GSTAmt = 0.00;
      double Tot_CGSTAmt = 0.00;
