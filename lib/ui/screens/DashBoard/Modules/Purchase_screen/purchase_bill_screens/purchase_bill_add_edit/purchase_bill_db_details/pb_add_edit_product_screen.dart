...
class PBAddEditScreenArguments {
  PurchaseBillTable model;
  String StateCode;
  String HeaderDiscAmnt;
  String QuotationNo;

  PBAddEditScreenArguments(
      this.model, this.StateCode, this.HeaderDiscAmnt, this.QuotationNo);
}

class PBAddEditScreen extends BaseStatefulWidget {
  static const routeName = '/PBAddEditScreen';
  final PBAddEditScreenArguments arguments;

  PBAddEditScreen(this.arguments);

  @override
  _PBAddEditScreenState createState() => _PBAddEditScreenState();
}

class _PBAddEditScreenState extends BaseState<PBAddEditScreen>
  ...
  void initState() {
    ...
    PurchaseBillNo = widget.arguments.QuotationNo;
    ...
    if (widget.arguments.model != null) {
      ...
      OrderNo = widget.arguments.model.OrderNo.toString();
    ...
    if (isProductExist == false) {
      if (isForUpdate) {
        await OfflineDbHelper.getInstance()
            .updatePurchaseBillProduct(PurchaseBillTable(
                0, //int pkID,
                "", //String InvoiceNo,
