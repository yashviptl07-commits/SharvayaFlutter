...
class NewPoOtherChargesScreenArguments {
  int StateCode;
  ...
  NewPoOtherChargesScreenArguments(
      this.StateCode,
      this.editModel,
...
class NewPoOtherChargeScreen extends BaseStatefulWidget {
  static const routeName = '/NewPoOtherChargeScreen';
  final NewPoOtherChargesScreenArguments arguments;

  NewPoOtherChargeScreen(this.arguments);

  @override
  _NewPoOtherChargeScreenState createState() => _NewPoOtherChargeScreenState();
}

class _NewPoOtherChargeScreenState extends BaseState<NewPoOtherChargeScreen>
  ...
  List<PurchaseOrderTable> productList = [];
                  ...
                  children: [
                    widget.arguments.ISCalculation == "Calculation"
                        ? Column(children: [
                            ...
                            Row(children: [
                              Expanded(flex: 1, child: AdvancePer()),
                              Expanded(flex: 1, child: AdvanceAmount())
                            ]),
                            SizedBox(
                              height: 20,
                            ),
                  ...
                  child: TextFormField(
                      ...
                      onTap: () => {
                            _headerDiscountController.selection = TextSelection(
                              baseOffset: 0,
                              extentOffset:
                                  _headerDiscountController.text.length,
                            )
                          },
  ...
  void _OnGetQuotationProductList(GetPOProductListState state) {
    ...
    if (productList != null) {
      ...
      List<PurchaseOrderTable> TempproductList1 =
          PurchaseOrderHeaderDiscountCalculation.txtHeadDiscount_WithZero(
              ...
              HeaderDisAmnt,
              CompanyStateCode,
              widget.arguments.StateCode.toString());
      ...
      _mainBloc.add(InsertPOProductEvent(TempproductList));
  ...
  void UpdatefromaddeditScreen(List<PurchaseOrderTable> tempproductList) {
    if (tempproductList != null) {
      double Tot_BasicAmount = 0.00;
      double Tot_GSTAmt = 0.00;
      double Tot_CGSTAmt = 0.00;
