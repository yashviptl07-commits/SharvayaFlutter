...
*/
  ...
  void getAddressFromLatLong() async {
    ...
    /* baseBloc.emit(ShowProgressIndicatorState(true));
    List<geo.Placemark> placemark = [];
    print("currentExactLocation" +" Latitude : "+ _currentPosition.latitude.toString() + " Longitude : " +_currentPosition.longitude.toString());
