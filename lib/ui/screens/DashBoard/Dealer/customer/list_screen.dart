...
class DCustomerListScreen extends BaseStatefulWidget {
  static const routeName = '/DCustomerListScreen';

  @override
  BaseState<DCustomerListScreen> createState() => _DCustomerListScreenState();
}

class _DCustomerListScreenState extends BaseState<DCustomerListScreen>
      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () async {
            ...
            navigateTo(context, DCustomerAdd_Edit_Screen.routeName);
          },
