...
class DCashVoucherListScreen extends BaseStatefulWidget {
  static const routeName = '/DCashVoucherListScreen';

  @override
  BaseState<DCashVoucherListScreen> createState() =>
      _DCashVoucherListScreenState();
}

class _DCashVoucherListScreenState extends BaseState<DCashVoucherListScreen>
      ...
      child: Scaffold(
              ...
              Expanded(
                child: RefreshIndicator(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [Text("CashVoucher List")],
                    ),
                  ),
                ),
              ),
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () async {
            ...
            navigateTo(context, DCashVoucherAddEditScreen.routeName);
          },
