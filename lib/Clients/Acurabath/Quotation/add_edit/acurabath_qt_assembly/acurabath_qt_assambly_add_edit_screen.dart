...
class AcurabathQTAssemblyAddEditScreenArguments {
  QTAssemblyTable editModel;
  String finishedProductID;
  String FromAddEdit;

  AcurabathQTAssemblyAddEditScreenArguments(
      this.editModel, this.finishedProductID, this.FromAddEdit);
}

class AcurabathQTAssemblyAddEditScreen extends BaseStatefulWidget {
  static const routeName = '/AcurabathQTAssemblyAddEditScreen';

  final AcurabathQTAssemblyAddEditScreenArguments arguments;

  AcurabathQTAssemblyAddEditScreen(this.arguments);

  @override
  _AcurabathQTAssemblyAddEditScreenState createState() =>
      _AcurabathQTAssemblyAddEditScreenState();
}

class _AcurabathQTAssemblyAddEditScreenState
    extends BaseState<AcurabathQTAssemblyAddEditScreen>
...
*/
  ...
  void QTAssemblyTableUpdateResponse(QTAssemblyTableUpdateState state) {
    print("mdf" + state.response.toString());
    navigateTo(context, AcurabathQTAssemblyScreen.routeName);
