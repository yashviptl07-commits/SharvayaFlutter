...
class AcurabathQTAssemblyScreenArgument {
  String quotation_No;
  String finishProductID;

  AcurabathQTAssemblyScreenArgument(this.quotation_No, this.finishProductID);
}

class AcurabathQTAssemblyScreen extends BaseStatefulWidget {
  static const routeName = '/AcurabathQTAssemblyScreen';
  final AcurabathQTAssemblyScreenArgument arguments;
  AcurabathQTAssemblyScreen(this.arguments);
  @override
  _AcurabathQTAssemblyScreenState createState() => _AcurabathQTAssemblyScreenState();
}

class _AcurabathQTAssemblyScreenState extends BaseState<AcurabathQTAssemblyScreen>
  ...
  Widget buildBody(BuildContext context) {
    return Scaffold(
      body: Column(
        children: [
          getCommonAppBar(context, baseTheme, "Acurabath Assembly List", showBack: true),
          Container(
