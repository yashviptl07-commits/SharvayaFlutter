...
class AddUpdateAcurabathQuotationScreenArguments {
  AcurabathQuotationDetails editModel;
...
class _AcurabathQuotationAddEditScreenState extends BaseState<AcurabathQuotationAddEditScreen>
  ...
  AcurabathQuotationDetails _editModel;
  bool _isForUpdate;
  String InquiryNo = "";
  int pkID = 0;
  ...
  String AcurabathDiscountPer="0.00";
  ...
  void initState() {
    ...
    if (_isForUpdate) {
      ...
      AcurabathDiscountPer = "0.00";

      edt_Portal_details.text = "--Select--";
      edt_Portal_details_ID.text ="0";
    }
...
*/
                                ...
                                navigateTo(context,
                                    AcurabathNewQuotationOtherChargeScreen.routeName,
                                        ...
                                        AcurabathNewQuotationOtherChargesScreenArguments(
                                                ...
                                                edt_HeaderDisc.text,
                                                "OtherCharge",
                                                addditionalCharges,AcurabathDiscountPer))
                                    .then((value) {
                                  setState(() {
                                    ...
                                    AcurabathDiscountPer = addditionalCharges.DisPer;
  ...
  void fillData() async {
   ...
   // AcurabathDiscountPer = _editModel.
    ...
    addditionalCharges = AddditionalCharges(
      ...
      ChargePer4: "0.00",
      ChargePer5: "0.00",
      DisPer:_editModel.DiscountPer.toStringAsFixed(2)
    );

    AcurabathDiscountPer = _editModel.DiscountPer.toStringAsFixed(2);
        ...
        if (edt_Portal_details.text != "") {
          if (temp.length != 0) {
            ...
            showCommonDialogWithTwoOptions(
              ...
              _inquiryBloc.add(AccurabathQuotationHeaderSaveCallEvent(
                  context,
                  pkID,
                  AccuraBathQuotationHeaderSaveRequest(
                      ...
                      QuotationKindAttn:edt_KindAtt.text.toString(),
                      ...
                      DiscountAmt: addditionalCharges.DiscountAmt,//edt_HeaderDisc.text.toString(),
                     ...
                     /* OrgCode: edt_OrganizationCode.text.toString() == "null"
                      ...
                      DiscountPer:AcurabathDiscountPer,
                      DeliveryDays:"0",
                      Validity:"0",
  ...
  void _OnQuotationProductSaveSucessResponse(
    ...
    showCommonDialogWithSingleOption(state.context, Msg,
        positiveButtonTitle: "OK", onTapOfPositiveButton: () {
      navigateTo(state.context, AcurabathQuotationListScreen.routeName,
          clearAllStack: true);
    });
  }
  ...
  void updateRetrunInquiryNoToDB(
    ...
    for(int i=0;i<TempproductList.length;i++)
    {
      NewQuotationProductTable vmsQuotationTable = NewQuotationProductTable(
        id:TempproductList[i].id,
        QuotationNo:ReturnQT_No.replaceAll("/", "-").toString(),
  ...
  void _OnTaptoSave() async {
    HeaderDisAmnt = 0.00;//double.parse(edt_HeaderDisc.text.toString());
    ...
    double diss = addditionalCharges.DiscountAmt.isNotEmpty?double.parse(addditionalCharges.DiscountAmt):0.00;
    double MinusHeaderDiscamnt = Tot_NetAmnt - diss;
...
/*
  ...
  List<double> UpdateHeaderDiscountCalculation(
    ...
    if (tempproductList != null) {
     ...
     double AcurabathDis =
      addditionalCharges.DisPer.isNotEmpty ? double.parse(addditionalCharges.DisPer) : 0.00;
     double AcurabathDisAmnt = addditionalCharges.DiscountAmt.isNotEmpty ? double.parse(addditionalCharges.DiscountAmt) : 0.00;

      double a = Tot_BasicAmount * AcurabathDis;
      double b = a / 100;
     double GrossAmnt = Tot_BasicAmount;
