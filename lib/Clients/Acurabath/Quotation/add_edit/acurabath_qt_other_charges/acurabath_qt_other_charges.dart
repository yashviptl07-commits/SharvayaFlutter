...
class _AcurabathNewQuotationOtherChargeScreenState
  ...
  String _AcurabathDiscountPer ="0.00";
  ...
  void initState() {
    ...
    _AcurabathDiscountPer = widget.arguments.AcurabathDiscountPer.toString();

    print("sjdjdf223" +
        " HeaderDiscount : " +
        widget.arguments.AcurabathDiscountPer.toString());
    ...
    _maindis_per.text =_addditionalCharges.DisPer;
  ...
  Future<bool> _onBackPressed() async {
    ...
    AddditionalCharges addditionalCharges = AddditionalCharges(
      DiscountAmt: _maindis_per_amnt.text.toString(),
      ...
      DisPer: _maindis_per.text.toString()
    );

    _AcurabathDiscountPer = _maindis_per.text.toString();
  ...
  void _OnGetQuotationProductList(GetQuotationProductListState state) {
    if (state.response != null) {
      ...
      List<QuotationTable> TempproductList =
          HeaderDiscountCalculation.txtHeadDiscount_TextChangedAcurabath(
              TempproductList1,
              0.00,
              CompanyStateCode,
              CustomerStateID,
