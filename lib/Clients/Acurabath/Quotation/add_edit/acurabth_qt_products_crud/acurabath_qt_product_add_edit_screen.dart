...
class AccurabathOldAddQuotationProductScreenArguments {
...
class AccurabathOldAddQuotationProductScreen extends BaseStatefulWidget {
  static const routeName = '/AccurabathOldAddQuotationProductScreen';
  final AccurabathOldAddQuotationProductScreenArguments arguments;

  AccurabathOldAddQuotationProductScreen(this.arguments);

  @override
  _AccurabathOldAddQuotationProductScreenState createState() =>
      _AccurabathOldAddQuotationProductScreenState();
}

class _AccurabathOldAddQuotationProductScreenState
    extends BaseState<AccurabathOldAddQuotationProductScreen>
    ...
    return Column(
      children: [
        getCommonAppBar(context, baseTheme,
            "${isForUpdate ? "Update" : "Add"} Acurabath Quotation Product",
                            ...
                            children: [
                              Expanded(
                                child: getCommonButton(baseTheme, () async {
                                  ...
                                  navigateTo(
                                          context,
                                          AcurabathSpecificationListScreen
                                              .routeName,
                                          arguments:
                                              AcurabathSpecificationListArgument(
                                                  _QuotationNo,
                              ...
                              Visibility(
                                ...
                                child: Expanded(
                                  child: getCommonButton(baseTheme, () async {
                                    ...
                                    navigateTo(
                                            context, AcurabathQTAssemblyScreen.routeName,
                                            arguments: AcurabathQTAssemblyScreenArgument(
                                                _QuotationNo,
                                                _productIDController.text
                                                    .toString()))
                                        .then((value) {
