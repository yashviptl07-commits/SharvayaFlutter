...
class AcurabathOldAddQuotationProductListArgument {
  String quotation_No;
  String stateCode;
...
class AcurabathOldQuotationProductListScreen extends BaseStatefulWidget {
  static const routeName = '/AcurabathOldQuotationProductListScreen';
  final AcurabathOldAddQuotationProductListArgument arguments;
  AcurabathOldQuotationProductListScreen(this.arguments);
  @override
  _AcurabathOldQuotationProductListScreenState createState() =>
      _AcurabathOldQuotationProductListScreenState();
}

class _AcurabathOldQuotationProductListScreenState
    extends BaseState<AcurabathOldQuotationProductListScreen>
  ...
  Widget buildBody(BuildContext context) {
    return Scaffold(
      appBar: /*PreferredSizeWidget(getCommonAppBar(context, baseTheme, "Quotation Product List", showBack: true)),*/
        ...
        title: Text("Acurabath Quotation Product List"),
      ),
        ...
        children: [
          ...
          FloatingActionButton(
            ...
            onPressed: () async {
              ...
              await navigateTo(
                      context, AccurabathOldAddQuotationProductScreen.routeName,
                      arguments:
                          AccurabathOldAddQuotationProductScreenArguments(
                              qtModel,
                              _StateCode,
                              _HeaderDiscAmnt,
                              QuotationNo))
...
//right now calling again get contacts, later it can be optimized
  ...
  Future<void> _onTapOfEditContact(int index) async {
    ...
    navigateTo(context, AccurabathOldAddQuotationProductScreen.routeName,
            arguments: AccurabathOldAddQuotationProductScreenArguments(
