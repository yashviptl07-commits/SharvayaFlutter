...
class AcurabathQuotationListScreen extends BaseStatefulWidget {
  static const routeName = '/AcurabathQuotationListScreen';

  @override
  _AcurabathQuotationListScreenState createState() =>
      _AcurabathQuotationListScreenState();
}

class _AcurabathQuotationListScreenState
    extends BaseState<AcurabathQuotationListScreen>
    with BasicScreen, WidgetsBindingObserver {
  QuotationBloc _QuotationBloc;
  int _pageNo = 0;
  AcurabathQuotationListResponse _quotationListResponse;
  bool expanded = true;
  var isRedirect = true;
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (BuildContext context) => _QuotationBloc
        ..add(AcurabathQuotationListCallEvent(
            _pageNo + 1,
      ...
      child: BlocConsumer<QuotationBloc, QuotationStates>(
        builder: (BuildContext context, QuotationStates state) {
          if (state is AcurabathQuotationListResponseState) {
            _onInquiryListCallSuccess(state);
          }
          if (state is AcurabathSearchQuotationListByNumberCallResponseState) {
        ...
        buildWhen: (oldState, currentState) {
          if (currentState is AcurabathQuotationListResponseState ||
              currentState is AcurabathSearchQuotationListByNumberCallResponseState ||
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: NewGradientAppBar(
          title: Text('Acurabath Quotation List'),
            ...
            children: [
              Expanded(
                child: RefreshIndicator(
                  onRefresh: () async {
                    _QuotationBloc.add(AcurabathQuotationListCallEvent(
                        1,
                        QuotationListApiRequest(
                            CompanyId: CompanyID.toString(),
                            LoginUserID: LoginUserID,
        ...
        floatingActionButton: /* IsAddRights == true
            ? FloatingActionButton(
                onPressed: () async {
                  ...
                  navigateTo(
                      context, AcurabathQuotationAddEditScreen.routeName);
                },
          ...
          onPressed: () async {
            ...
            navigateTo(context, AcurabathQuotationAddEditScreen.routeName);
          },
          child: const Icon(Icons.add),
          backgroundColor: colorPrimary,
        ),
  ...
  void _onInquiryListCallSuccess(AcurabathQuotationListResponseState state) async {
  ...
  ExpantionCustomer(BuildContext context, int index) {
    AcurabathQuotationDetails model = _quotationListResponse.details[index];
  ...
  Future<void> _onTapOfSearchView() async {
    navigateTo(context, AcurabathSearchQuotationScreen.routeName).then((value) {
      if (value != null) {
        _searchDetails = value;
        _QuotationBloc.add(AcurabathSearchQuotationListByNumberCallEvent(
            _searchDetails.value,
  ...
  void _onInquiryListByNumberCallSuccess(
      AcurabathSearchQuotationListByNumberCallResponseState state) {
    _quotationListResponse = state.response;
  }
  ...
  Future<void> _showMyDialog(
      AcurabathQuotationDetails model, String GenerateMode) async {
  ...
  Future<void> _showEmailMyDialog(AcurabathQuotationDetails model) async {
    return showDialog<int>(
      context: context,
      barrierDismissible: false, // user must tap button!
      builder: (BuildContext context123) {
  ...
  GenerateQT(
      AcurabathQuotationDetails model, BuildContext context123, String GenerateMode1) {
    return Center(
      child: Container(
        child: Stack(
          children: [
  ...
  OneTimeGenerateQT(
      AcurabathQuotationDetails model, BuildContext context123, String GenerateMode) {
    return Center(
      child: Container(
  ...
  GenerateQTSendEmail(AcurabathQuotationDetails model, BuildContext context123) {
    return Center(
      child: Container(
        child: Stack(
          children: [
  ...
  void _onTaptoEditQuotation(AcurabathQuotationDetails model) async {
    await _onTapOfDeleteALLProduct();

    navigateTo(context, AcurabathQuotationAddEditScreen.routeName,
            arguments: AddUpdateAcurabathQuotationScreenArguments(model))
        .then((value) {
      _QuotationBloc.add(AcurabathQuotationListCallEvent(
          1,
          QuotationListApiRequest(
  ...
  void _OnDeleteQuotationRequest(AcurabathQuotationDetails model) {
