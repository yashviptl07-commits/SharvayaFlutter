class MultiNoToProductDetailsResponse1 {
  List<MultiNoToProductDetailsResponse1Details> details;
  int totalCount;

  MultiNoToProductDetailsResponse1({this.details, this.totalCount});

  MultiNoToProductDetailsResponse1.fromJson(Map<String, dynamic> json) {
    if (json['details'] != null) {
      details = [];
      json['details'].forEach((v) {
        details.add(new MultiNoToProductDetailsResponse1Details.fromJson(v));
      });
    }
...
class MultiNoToProductDetailsResponse1Details {
  int pkID;
  String inquiryNo;
  int productID;
  double unitPrice;
  ...
  MultiNoToProductDetailsResponse1Details(
      {this.pkID,
      this.inquiryNo,
      this.productID,
      this.unitPrice,
  ...
  MultiNoToProductDetailsResponse1Details.fromJson(Map<String, dynamic> json) {
