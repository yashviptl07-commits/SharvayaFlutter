...
class ToDoDetails {
  ...
  ToDoDetails.fromJson(Map<String, dynamic> json) {
    ...
    startDate = json['StartDate'] == null|| json['StartDate'] == "null" ? "" : json['StartDate'];
    dueDate = json['DueDate'] == null || json['DueDate'] == "null"? "" : json['DueDate'];
    deliveryDate = json['DeliveryDate'] == null || json['DeliveryDate'] == "null"? "" : json['DeliveryDate'];
    completionDate =
        json['CompletionDate'] == null || json['CompletionDate'] == "null"? "" : json['CompletionDate'];
