class TeleCallerListResponse {
  List<TeleCallerListDetails> details;
  int totalCount;

  TeleCallerListResponse({this.details, this.totalCount});

  TeleCallerListResponse.fromJson(Map<String, dynamic> json) {
    if (json['details'] != null) {
      details = [];
      json['details'].forEach((v) {
        details.add(new TeleCallerListDetails.fromJson(v));
      });
    }
...
class TeleCallerListDetails {
  ...
  TeleCallerListDetails.fromJson(Map<String, dynamic> json) {
    ...
    DisqualifedRemarks =
        json['DisqualifedRemarks'] == null ? "" : json['DisqualifedRemarks'];
    ...
    Brand =
        json['Brand'] == null || json['Brand'] == 'null' ? "" : json['Brand'];
