class DebitNotesListResponse {
  List<DebitNotesListResponseDetails> details;
  int totalCount;

  DebitNotesListResponse({this.details, this.totalCount});

  DebitNotesListResponse.fromJson(Map<String, dynamic> json) {
    if (json['details'] != null) {
      details = [];
      json['details'].forEach((v) {
        details.add(new DebitNotesListResponseDetails.fromJson(v));
      });
    }
...
class DebitNotesListResponseDetails {
  int rowNum;
  int pkID;
  String voucherNo;
  String voucherDate;
  ...
  DebitNotesListResponseDetails.fromJson(Map<String, dynamic> json) {
    rowNum = json['RowNum'];
    pkID = json['pkID'];
