class MIGetFetDetailByOrderNoListResponse {
  List<MIGetFetDetailByOrderNoListResponseDetails> details;
  int totalCount;

  MIGetFetDetailByOrderNoListResponse(
      {this.details, this.totalCount});

  MIGetFetDetailByOrderNoListResponse.fromJson(
      Map<String, dynamic> json) {
    if (json['details'] != null) {
      details = [];
      json['details'].forEach((v) {
        details.add(
            new MIGetFetDetailByOrderNoListResponseDetails.fromJson(v));
      });
    }
...
class MIGetFetDetailByOrderNoListResponseDetails {
  int productID;
  int taxType;
  String productName;
  String ordProductID;
  ...
  MIGetFetDetailByOrderNoListResponseDetails(
      {this.productID,
        this.taxType,
        this.productName,
        this.ordProductID,
  ...
  MIGetFetDetailByOrderNoListResponseDetails.fromJson(
      Map<String, dynamic> json) {
