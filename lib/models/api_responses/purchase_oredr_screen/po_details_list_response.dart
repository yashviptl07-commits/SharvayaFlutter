class PurchaseOrderDetailsListResponse {
  List<PurchaseOrderDetailsListResponseDetails> details;
  int totalCount;
  PurchaseOrderDetailsListResponse({this.details, this.totalCount});
  PurchaseOrderDetailsListResponse.fromJson(Map<String, dynamic> json) {
    if (json['details'] != null) {
      details = [];
      json['details'].forEach((v) {
        details.add(new PurchaseOrderDetailsListResponseDetails.fromJson(v));
      });
    }
...
class PurchaseOrderDetailsListResponseDetails {
  String productName;
  int pkID;
  String orderNo;
  int productID;
  ...
  PurchaseOrderDetailsListResponseDetails(
      {this.productName,
      this.pkID,
      this.orderNo,
      this.productID,
  ...
  PurchaseOrderDetailsListResponseDetails.fromJson(Map<String, dynamic> json) {
