class POApprovalListResponse {
  List<POApprovalListResponseDetails> details;
  int totalCount;

  POApprovalListResponse({this.details, this.totalCount});

  POApprovalListResponse.fromJson(Map<String, dynamic> json) {
    if (json['details'] != null) {
      details = [];
      json['details'].forEach((v) {
        details.add(new POApprovalListResponseDetails.fromJson(v));
      });
    }
...
class POApprovalListResponseDetails {
  int rowNum;
  int pkID;
  String orderNo;
  String orderDate;
  ...
  POApprovalListResponseDetails.fromJson(Map<String, dynamic> json) {
    rowNum = json['RowNum'];
    pkID = json['pkID'];
