...
class InquiryDetails {
  ...
  InquiryDetails.fromJson(Map<String, dynamic> json) {
    ...
    assignedEmployeeName = json['AssignedEmployeeName'] == null ? "" : json['AssignedEmployeeName'];
    assignToEmployee = json['AssignToEmployee'] == null ? 0 : json['AssignToEmployee'];
  }
