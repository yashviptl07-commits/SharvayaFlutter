...
class SaleBillDetails {
  ...
  SaleBillDetails.fromJson(Map<String, dynamic> json) {
    ...
    fixedLedgerName =
        json['FixedLedgerName'] == null ? "" : json['FixedLedgerName'];
    ...
    terminationOfDelieryName = json['TerminationOfDelieryName'] == null
        ? ""
        : json['TerminationOfDelieryName'];
    ...
    createdEmployeeMobile = json['CreatedEmployeeMobile'] == null
        ? ""
        : json['CreatedEmployeeMobile'];
    updatedEmployeeName =
