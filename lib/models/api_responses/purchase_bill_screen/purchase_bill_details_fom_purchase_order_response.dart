class MultiNoToProductDetailsFromPurchaseOrderResponse {
  List<Details> details;
  int totalCount;

  MultiNoToProductDetailsFromPurchaseOrderResponse(
      {this.details, this.totalCount});

  MultiNoToProductDetailsFromPurchaseOrderResponse.fromJson(
