class MultiExpenseModeListResponse {
  List<Details> details;
  int totalCount;

  MultiExpenseModeListResponse({this.details, this.totalCount});

  MultiExpenseModeListResponse.fromJson(Map<String, dynamic> json) {
