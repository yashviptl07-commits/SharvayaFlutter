class SoNoToProductResponse {
  List<SoNoToProductResponseDetails> details;
  int totalCount;

  SoNoToProductResponse({this.details, this.totalCount});

  SoNoToProductResponse.fromJson(Map<String, dynamic> json) {
    if (json['details'] != null) {
      details = [];
      json['details'].forEach((v) {
        details.add(new SoNoToProductResponseDetails.fromJson(v));
      });
    }
...
class SoNoToProductResponseDetails {
  String productName;
  int pkID;
  String orderNo;
  int productID;
  ...
  SoNoToProductResponseDetails.fromJson(Map<String, dynamic> json) {
