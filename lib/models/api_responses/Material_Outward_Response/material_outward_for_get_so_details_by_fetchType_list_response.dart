class MaterialOutwardPendingSalesOrderDetailsByFetchTypeListResponse {
  List<MaterialOutwardPendingSalesOrderDetailsByFetchTypeListResponseDetails> details;
  int totalCount;

  MaterialOutwardPendingSalesOrderDetailsByFetchTypeListResponse(
      {this.details, this.totalCount});

  MaterialOutwardPendingSalesOrderDetailsByFetchTypeListResponse.fromJson(
      Map<String, dynamic> json) {
    if (json['details'] != null) {
      details = [];
      json['details'].forEach((v) {
        details.add(new MaterialOutwardPendingSalesOrderDetailsByFetchTypeListResponseDetails.fromJson(v));
      });
    }
...
class MaterialOutwardPendingSalesOrderDetailsByFetchTypeListResponseDetails {
  int productID;
  int taxType;
  String productName;
  String ordProductID;
  ...
  MaterialOutwardPendingSalesOrderDetailsByFetchTypeListResponseDetails(
      {this.productID,
        this.taxType,
        this.productName,
        this.ordProductID,
  ...
  MaterialOutwardPendingSalesOrderDetailsByFetchTypeListResponseDetails.fromJson(Map<String, dynamic> json) {
