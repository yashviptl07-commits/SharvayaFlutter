//QuotationProductDetails1, QuotationNoToProductResponse1

class QuotationNoToProductResponse1 {
  List<QuotationProductDetails1> details;
  int totalCount;

  QuotationNoToProductResponse1({this.details, this.totalCount});

  QuotationNoToProductResponse1.fromJson(Map<String, dynamic> json) {
    if (json['details'] != null) {
      details = [];
      json['details'].forEach((v) {
        details.add(new QuotationProductDetails1.fromJson(v));
      });
    }
...
class QuotationProductDetails1 {
  int rowNum;
  int pkID;
  String quotationNo;
  ...
  QuotationProductDetails1.fromJson(Map<String, dynamic> json) {
    ...
    headerDiscAmt =
        json['HeaderDiscAmt'] == null ? 0.00 : json['HeaderDiscAmt'];
    roffAmt = json['RoffAmt'] == null ? 0.00 : json['RoffAmt'];
    basicAmt = json['BasicAmt'] == null ? 0.00 : json['BasicAmt'];
    headerDiscountAmt =
        json['HeaderDiscountAmt'] == null ? 0.00 : json['HeaderDiscountAmt'];
    ...
    gradeName = json['GradeName'] == null ? "" : json['GradeName'];
    sizeName = json['SizeName'] == null ? "" : json['SizeName'];
    finishName = json['FinishName'] == null ? "" : json['FinishName'];
    thicknessName = json['ThicknessName'] == null ? "" : json['ThicknessName'];
    designName = json['DesignName'] == null ? "" : json['DesignName'];
  }
