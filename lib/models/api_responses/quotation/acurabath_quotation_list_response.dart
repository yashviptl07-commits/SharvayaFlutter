class AcurabathQuotationListResponse {
  List<AcurabathQuotationDetails> details;
  int totalCount;

  AcurabathQuotationListResponse.fromJson(Map<String, dynamic> json) {
    if (json['details'] != null) {
      details = [];
      json['details'].forEach((v) {
        details.add(new AcurabathQuotationDetails.fromJson(v));
      });
    }
...
class AcurabathQuotationDetails {
  int rowNum;
  int pkID;
  String quotationNo;
  ...
  AcurabathQuotationDetails.fromJson(Map<String, dynamic> json) {
    ...
    quotationSubject =
    json['QuotationSubject'] == null ? "" : json['QuotationSubject'];
    quotationKindAttn =
    json['QuotationKindAttn'] == null ? "" : json['QuotationKindAttn'];
    quotationHeader =
    json['QuotationHeader'] == null ? "" : json['QuotationHeader'];
    quotationFooter =
    json['QuotationFooter'] == null ? "" : json['QuotationFooter'];
    assumptionRemark =
    json['AssumptionRemark'] == null ? "" : json['AssumptionRemark'];
    additionalRemark =
    json['AdditionalRemark'] == null ? "" : json['AdditionalRemark'];
    ...
    createdEmployeeMobileNo = json['CreatedEmployeeMobileNo'] == null
        ? ""
        : json['CreatedEmployeeMobileNo'];
    updatedEmployeeName =
    json['UpdatedEmployeeName'] == null ? "" : json['UpdatedEmployeeName'];
    companyID = json['CompanyID'] == null ? 0 : json['CompanyID'];
    quotationAmount =
    json['QuotationAmount'] == null ? 0.00 : json['QuotationAmount'];
    projGenCount = json['ProjGenCount'] == null ? 0 : json['ProjGenCount'];
    projTotalCount =
    json['ProjTotalCount'] == null ? 0 : json['ProjTotalCount'];
    ...
    quotationCategory =
    json['QuotationCategory'] == null ? "" : json['QuotationCategory'];
    ...
    json['CurrencySymbol'] == null ? "" : json['CurrencySymbol'];
    ExchangeRate = json['ExchangeRate'] == null ? 0.00 : json['ExchangeRate'];
    ChargePer1 = json['ChargePer1']==null?0.00:json['ChargePer1'];
    ChargePer2 = json['ChargePer2']==null?0.00:json['ChargePer2'];
    ChargePer3 = json['ChargePer3']==null?0.00:json['ChargePer3'];
    ChargePer4 = json['ChargePer4']==null?0.00:json['ChargePer4'];
    ChargePer5 = json['ChargePer5']==null?0.00:json['ChargePer5'];
    DiscountPer = json['DiscountPer']==null?0.00:json['DiscountPer'];
    DeliveryDays = json['DeliveryDays']==null?"0":json['DeliveryDays'];
