class QuoShipmentlistResponse {
  List<QuoShipmentlistResponseDetails> details;
  int totalCount;

  QuoShipmentlistResponse({this.details, this.totalCount});

  QuoShipmentlistResponse.fromJson(Map<String, dynamic> json) {
    if (json['details'] != null) {
      details = [];
      json['details'].forEach((v) {
        details.add(new QuoShipmentlistResponseDetails.fromJson(v));
      });
    }
...
class QuoShipmentlistResponseDetails {
  int rowNum;
  int pkID;
  String quotationNo;
  String sCompanyName;
  ...
  QuoShipmentlistResponseDetails(
      {this.rowNum,
      this.pkID,
      this.quotationNo,
      this.sCompanyName,
  ...
  QuoShipmentlistResponseDetails.fromJson(Map<String, dynamic> json) {
