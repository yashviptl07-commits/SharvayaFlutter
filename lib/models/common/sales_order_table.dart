class SalesOrderTable {
  ...
  @override
  String toString() {
    return 'SalesOrderTable{id: $id, SalesOrderNo: $SalesOrderNo, ProductSpecification: $ProductSpecification, ProductID: $ProductID, ProductName: $ProductName, Unit: $Unit, Quantity: $Quantity, UnitRate: $UnitRate, DiscountPercent: $DiscountPercent, DiscountAmt: $DiscountAmt, NetRate: $NetRate, Amount: $Amount, TaxRate: $TaxRate, TaxAmount: $TaxAmount, NetAmount: $NetAmount, CGSTPer: $CGSTPer, SGSTPer: $SGSTPer, IGSTPer: $IGSTPer, CGSTAmt: $CGSTAmt, SGSTAmt: $SGSTAmt, IGSTAmt: $IGSTAmt, StateCode: $StateCode, TaxType: $TaxType, pkID: $pkID, LoginUserID: $LoginUserID, CompanyId: $CompanyId, BundleId: $BundleId, HeaderDiscAmt: $HeaderDiscAmt, DeliveryDate: $DeliveryDate, DocRef: $DocRef}';
  }
