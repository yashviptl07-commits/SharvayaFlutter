class DealerSalesBillOtherChargeTable {
  int id;
  ...
  @override
  String toString() {
    return 'DealerSalesBillOtherChargeTable{id: $id, Headerdiscount: $Headerdiscount, Tot_BasicAmt: $Tot_BasicAmt, OtherChargeWithTaxamt: $OtherChargeWithTaxamt, Tot_GstAmt: $Tot_GstAmt, OtherChargeExcludeTaxamt: $OtherChargeExcludeTaxamt, Tot_NetAmount: $Tot_NetAmount, ChargeID1: $ChargeID1, ChargeAmt1: $ChargeAmt1, ChargeBasicAmt1: $ChargeBasicAmt1, ChargeGSTAmt1: $ChargeGSTAmt1, ChargeID2: $ChargeID2, ChargeAmt2: $ChargeAmt2, ChargeBasicAmt2: $ChargeBasicAmt2, ChargeGSTAmt2: $ChargeGSTAmt2, ChargeID3: $ChargeID3, ChargeAmt3: $ChargeAmt3, ChargeBasicAmt3: $ChargeBasicAmt3, ChargeGSTAmt3: $ChargeGSTAmt3, ChargeID4: $ChargeID4, ChargeAmt4: $ChargeAmt4, ChargeBasicAmt4: $ChargeBasicAmt4, ChargeGSTAmt4: $ChargeGSTAmt4, ChargeID5: $ChargeID5, ChargeAmt5: $ChargeAmt5, ChargeBasicAmt5: $ChargeBasicAmt5, ChargeGSTAmt5: $ChargeGSTAmt5}';
  }
}
