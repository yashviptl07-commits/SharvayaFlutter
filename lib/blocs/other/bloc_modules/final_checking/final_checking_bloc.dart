...
class FinalCheckingBloc
    extends Bloc<FinalCheckingListEvent, FinalCheckingListState> {
  ...
  Stream<FinalCheckingListState> _mapFinalCheckingListCallEventToState(
    ...
    try {
      ...
      print("hi");
      FinalCheckingListResponse respo =
          await userRepository.FinalCheckingListCall(
              event.pageNo, event.finalCheckingListRequest);
  ...
  Stream<FinalCheckingListState> _mapSearchFinalCheckingCallEventToState(
    ...
    try {
      ...
      //call your api as follows
      print("hi");
      FinalCheckingListResponse respo = await userRepository
          .searchfinalchecking(event.searchFinalCheckingRequest);
  ...
  Stream<FinalCheckingListState> _mapSearchFinalCheckingLabelCallEventToState(
    ...
    try {
      ...
      //call your api as follows
      print("hi");
      SearchFinalCheckingLabelResponse respo = await userRepository
          .searchfinalcheckinglabel(event.searchFinalCheckingRequest);
  ...
  Stream<FinalCheckingListState> _mapFinalCheckingItemsCallEventToState(
    ...
    try {
      ...
      FinalCheckingItemsResponse respo =
          await userRepository.FinalCheckingItemsAPI(
              event.finalCheckingItemsRequest);
  ...
  Stream<FinalCheckingListState> _mapCheckingNoToCheckingItemsEventToState(
    ...
    try {
      ...
      CheckingNoToCheckingItemsResponse respo =
          await userRepository.CheckingNoToCheckingItemsAPI(
              event.checkingNoToCheckingItemsRequest);
  ...
  Stream<FinalCheckingListState> _mapFinalCheckingHeaderSaveEventToState(
    ...
    try {
      ...
      FinalCheckingHeaderSaveResponse respo =
          await userRepository.finalCheckingHeaderSaveApi(
              event.pkID, event.finalCheckingHeaderSaveRequest);
  ...
  Stream<FinalCheckingListState>
      _mapFinalCheckingDeleteAllItemRequestEventToState(
          FinalCheckingDeleteAllItemRequestCallEvent event) async* {
    try {
      baseBloc.emit(ShowProgressIndicatorState(true));

      FinalCheckingDeleteAllItemResponse respo =
          await userRepository.finalCheckingDeleteAllItemApi(
              event.FinalcheckingNo, event.finalCheckingDeleteAllItemsRequest);
  ...
  Stream<FinalCheckingListState> _mapFinalCheckingDeleteEventToState(
    ...
    try {
      ...
      FinalCheckingDeleteAllItemResponse respo =
          await userRepository.finalCheckingDeleteApi(
              event.pkID, event.finalCheckingDeleteAllItemsRequest);
