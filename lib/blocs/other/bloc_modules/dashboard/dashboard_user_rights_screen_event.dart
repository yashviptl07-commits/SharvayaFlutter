...
class DashBoardCountRequestEvent extends DashBoardScreenEvents {
  final DashBoardCountRequest request;

  DashBoardCountRequestEvent(this.request);
}

class MyGetPunchingEvent extends DashBoardScreenEvents {
  final int pkID;
  final MyGetPunchingRequest request;

  MyGetPunchingEvent(this.pkID, this.request);
}
