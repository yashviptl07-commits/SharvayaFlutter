...
class DolphinComplaintVisitBloc
    extends Bloc<DolphinComplaintVisitEvents, DolphinComplaintVisitStates> {
  Repository userRepository = Repository.getInstance();
  BaseBloc baseBloc;

  DolphinComplaintVisitBloc(this.baseBloc)
      : super(DolphinComplaintVisitInitialState());

  @override
  Stream<DolphinComplaintVisitStates> mapEventToState(
      DolphinComplaintVisitEvents event) async* {
  ...
  Stream<DolphinComplaintVisitStates> _mapAttenVisitCallEventToState(
    ...
    try {
      ...
      DolphinComplaintVisitListResponse respo =
          await userRepository.getDolphinComplaintVisitList(
              event.pageNo, event.dolphinComplaintVisitListRequest);
  ...
  Stream<DolphinComplaintVisitStates> _mapSearchByNameCallEventToState(
    ...
    try {
      ...
      DolphinComplaintSearchResponse response = await userRepository
          .getDolphinComplaintSearchByName(event.dolphinComplaintSearchRequest);
  ...
  Stream<DolphinComplaintVisitStates> _mapSearchByIDCallEventToState(
    ...
    try {
      ...
      DolphinComplaintVisitListResponse response =
          await userRepository.getDolphinComplaintVisitSearchByID(
              event.pkID, event.dolphinComplaintSearchByIDRequest);
  ...
  Stream<DolphinComplaintVisitStates>
      _mapDolphinComplaintVisitDeleteCallEventToState(
          DolphinComplaintVisitDeleteCallEvent event) async* {
    try {
      baseBloc.emit(ShowProgressIndicatorState(true));

      DolphinComplaintVisitDeleteResponse response =
          await userRepository.getDolphinComplaintVisitDelete(
              event.dolphinComplaintVisitDeleteRequest);
...
//DolphinComplaintVisitSaveRequest
  ...
  Stream<DolphinComplaintVisitStates>
      _mapDolphinComplaintVisitSaveCallEventToState(
          DolphinComplaintVisitSaveCallEvent event) async* {
    try {
      baseBloc.emit(ShowProgressIndicatorState(true));

      DolphinComplaintVisitSaveResponse response =
          await userRepository.getDolphinComplaintVisitSave(
              event.pkID, event.dolphinComplaintVisitSaveRequest);
