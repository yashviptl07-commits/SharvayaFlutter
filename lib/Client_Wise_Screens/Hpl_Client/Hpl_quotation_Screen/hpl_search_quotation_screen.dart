...
class HplSearchQuotationScreen extends BaseStatefulWidget {
  static const routeName = '/HplSearchQuotationScreen';

  @override
  _HplSearchQuotationScreenState createState() =>
      _HplSearchQuotationScreenState();
}

class _HplSearchQuotationScreenState extends BaseState<HplSearchQuotationScreen>
