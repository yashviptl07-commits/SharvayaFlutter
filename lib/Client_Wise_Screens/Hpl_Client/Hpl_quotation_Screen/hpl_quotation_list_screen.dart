...
class HplQuotationListScreen extends BaseStatefulWidget {
  static const routeName = '/HplQuotationListScreen';

  @override
  _HplQuotationListScreenState createState() => _HplQuotationListScreenState();
}

class _HplQuotationListScreenState extends BaseState<HplQuotationListScreen>
        ...
        floatingActionButton: IsAddRights == true
            ? FloatingActionButton(
                onPressed: () async {
                  ...
                  navigateTo(context, HplQuotationAddEditScreen.routeName);
                },
                        ...
                        children: <Widget>[
                          ...
                          GestureDetector(
                            onTap: () async {
                              ...
                              /*print("sldkjfdkf" +model.contactNo1);


                              String numberwithw = "+91 "+model.contactNo1;

                              var contact = numberwithw;
                              ...
                              try{
                                ...
                                showCommonDialogWithSingleOption(context, "WhatsApp is not installed.",
                  ...
                  Container(
                    child: Row(
                        ...
                        children: <Widget>[
                              ...
                              showCommonDialogWithTwoOptions(context,
                                  ...
                                  onTapOfNegativeButton: () async {
                                    ...
                                    String PrintHeaderYES = SiteURL +
                                        "/Quotation.aspx?PrintHeader=yes&MobilePdf=yes&userid=" +
                                        LoginUserID +
                                        "&password=" +
                                        Password +
                                        "&pQuotID=" +
                          ...
                          GestureDetector(
                            onTap: () {
                              _QuotationBloc.add(RevisedQuotationRequestEvent(
                              ...
                              children: [
                                Card(
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                        child: Image.network(
                                            "http://demo.sharvayainfotech.in/images/recaptcha.png",
                                            height: 25,
                                            fit: BoxFit.fill)),
                                  ),
                                ),
  ...
  Future<void> _onTapOfSearchView() async {
    navigateTo(context, HplSearchQuotationScreen.routeName).then((value) {
      if (value != null) {
            ...
            child: Column(
              children: <Widget>[
                Visibility(
                  visible: true,
                  child:
                      GenerateQT(model, context123, GenerateMode, printWebURL),
                )
                //GetCircular123(),
              ],
            ),
  ...
  GenerateQT(QuotationDetails model, BuildContext context123,
      String GenerateMode1, String printWebURL) {
    return Center(
      child: Container(
        child: Stack(
          children: [
  ...
  void _onTaptoEditQuotation(QuotationDetails model) async {
    ...
    navigateTo(context, HplQuotationAddEditScreen.routeName,
            arguments: HplAddUpdateQuotationScreenArguments(model))
        .then((value) {
      _QuotationBloc.add(QuotationListCallEvent(
          1,
          QuotationListApiRequest(
  ...
  void _onRevisedQuotationResponseState(RevisedQuotationResponseState state) {
    if (state.revisedQuotationResponse.details.isNotEmpty) {
      _QuotationBloc.add(QuotationPkIdToDetailsRequestEvent(
          QuotationPkIdToDetailsRequest(
              pkID:
                  state.revisedQuotationResponse.details[0].column1.toString(),
              LoginUserID: LoginUserID,
              PageNo: "1",
              PageSize: "1",
              CompanyId: CompanyID.toString())));
      ...
      showCommonDialogWithSingleOption(
          context, "Something Went Wrong Kindly Contact to Our Support Team !",
          positiveButtonTitle: "OK", onTapOfPositiveButton: () {
        Navigator.pop(context);
      });
    }
