...
class HplSearchQuotationCustomerScreen extends BaseStatefulWidget {
  static const routeName = '/HplSearchQuotationCustomerScreen';

  @override
  _HplSearchQuotationCustomerScreenState createState() =>
      _HplSearchQuotationCustomerScreenState();
}

class _HplSearchQuotationCustomerScreenState
    extends BaseState<HplSearchQuotationCustomerScreen>
