...
class HplSpecificationListArgument {
  String inquiry_No;
  String ProductID;

  HplSpecificationListArgument(this.inquiry_No, this.ProductID);
}

class HplSpecificationListScreen extends BaseStatefulWidget {
  static const routeName = '/HplSpecificationListScreen';
  final HplSpecificationListArgument arguments;

  HplSpecificationListScreen(this.arguments);
  @override
  _HplSpecificationListScreenState createState() =>
      _HplSpecificationListScreenState();
}

class _HplSpecificationListScreenState
    extends BaseState<HplSpecificationListScreen>
...
*/
    ...
    navigateTo(context, HplQuotationSpecificationAddEditScreen.routeName,
            arguments: HplAddUpdateQuotationSpecificationScreenArguments(model))
        .then((value) {
