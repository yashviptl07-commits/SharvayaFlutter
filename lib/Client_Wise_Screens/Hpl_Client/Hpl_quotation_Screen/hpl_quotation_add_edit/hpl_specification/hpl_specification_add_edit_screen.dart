...
class HplAddUpdateQuotationSpecificationScreenArguments {
  QuotationSpecificationTable editModel;

  HplAddUpdateQuotationSpecificationScreenArguments(this.editModel);
}

class HplQuotationSpecificationAddEditScreen extends BaseStatefulWidget {
  static const routeName = '/HplQuotationSpecificationAddEditScreen';
  final HplAddUpdateQuotationSpecificationScreenArguments arguments;

  HplQuotationSpecificationAddEditScreen(this.arguments);

  @override
  _HplQuotationSpecificationAddEditScreenState createState() =>
      _HplQuotationSpecificationAddEditScreenState();
}

class _HplQuotationSpecificationAddEditScreenState
    extends BaseState<HplQuotationSpecificationAddEditScreen>
