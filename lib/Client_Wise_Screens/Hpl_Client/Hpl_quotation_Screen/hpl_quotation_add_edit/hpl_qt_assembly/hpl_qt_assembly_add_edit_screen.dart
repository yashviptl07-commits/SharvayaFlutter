...
class HplQTAssemblyAddEditScreen extends BaseStatefulWidget {
  static const routeName = '/HplQTAssemblyAddEditScreen';

  final QTAssemblyAddEditScreenArguments arguments;

  HplQTAssemblyAddEditScreen(this.arguments);

  @override
  _HplQTAssemblyAddEditScreenState createState() =>
      _HplQTAssemblyAddEditScreenState();
}

class _HplQTAssemblyAddEditScreenState
    extends BaseState<HplQTAssemblyAddEditScreen>
...
*/
  ...
  void QTAssemblyTableUpdateResponse(QTAssemblyTableUpdateState state) {
    print("mdf" + state.response.toString());
    navigateTo(context, HplQTAssemblyScreen.routeName);
