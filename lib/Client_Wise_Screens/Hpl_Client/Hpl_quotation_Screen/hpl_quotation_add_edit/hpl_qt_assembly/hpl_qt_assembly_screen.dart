...
class HplQTAssemblyScreenArgument {
  String quotation_No;
  String finishProductID;

  HplQTAssemblyScreenArgument(this.quotation_No, this.finishProductID);
}

class HplQTAssemblyScreen extends BaseStatefulWidget {
  static const routeName = '/HplQTAssemblyScreen';
  final HplQTAssemblyScreenArgument arguments;
  HplQTAssemblyScreen(this.arguments);
  @override
  _HplQTAssemblyScreenState createState() => _HplQTAssemblyScreenState();
}

class _HplQTAssemblyScreenState extends BaseState<HplQTAssemblyScreen>
