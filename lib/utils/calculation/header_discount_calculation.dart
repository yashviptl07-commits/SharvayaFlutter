...
class HeaderDiscountCalculation {
  ...
  static List<QuotationTable1> txtHeadDiscount_TextChanged1(
      List<QuotationTable1> qtTable,
      double txtHeadDiscount,
      String CompanyStateID,
      String CustomerStateID) {
    List<QuotationTable1> outqtTable = [];

    double TotalAmt = 0;
    double HeaderDiscAmt = txtHeadDiscount != null ? txtHeadDiscount : 0;
    double HeaderDiscItemWise = 0;
    if (qtTable != null) {
      qtTable.forEach((QuotationTable1 car) {
        //print("${car.name} is electric? ${car.isElectric}");
        TotalAmt += car.NetAmount != null ? car.NetAmount : 0;
      });
      ...
      qtTable.forEach((QuotationTable1 car) {
        ...
        print("Amount1TEST" +
            ...
            "  NetAmountU : " +
            productoutparam.NetAmt.toString());
        outqtTable.add(QuotationTable1(
            car.QuotationNo,
            car.ProductSpecification,
            car.ProductID,
            car.ProductName,
  ...
  static List<QuotationTable> txtHeadDiscount_TextChangedAcurabath(
    List<QuotationTable> qtTable,
    double txtHeadDiscount,
    String CompanyStateID,
    String CustomerStateID,
  ...
  static List<double> funCalculateAccurabath(
    double hdnOthChrgGST1,
    double hdnOthChrgGST2,
    double hdnOthChrgGST3,
    double hdnOthChrgGST4,
    ...
    double txtHeadDiscount,
    double Tot_otherChargeWithTax,
    double Tot_otherChargeExcludeTax,
    double acurabath_dis,
    double acurabath_amnt,
  ) {
    /*
    double txtTotOthChrgBeforeGST1 = hdnOthChrgBasic1 +
        hdnOthChrgBasic2 +
    ...
    double a1 = hdnTotCGSTAmt + hdnTotSGSTAmt + hdnTotIGSTAmt;
    double a2 = (a1 * acurabath_dis) / 100;
    //double hdnTotItemGST = (a1 * acurabath_dis) /100;
    double hdnTotItemGST = hdnTotCGSTAmt + hdnTotSGSTAmt + hdnTotIGSTAmt;

    print("jdfdsf56" +
        "OnlyItemGST : " +
        hdnTotItemGST.toStringAsFixed(2) +
        " Basic Amnt : " +
        txtTotBasicAmt.toStringAsFixed(2) +
        " Other GST : " +
        hdnOthChrgGST1.toStringAsFixed(2));

    double a11 = hdnTotItemGST +
        hdnOthChrgGST1 +
        hdnOthChrgGST2 +
        hdnOthChrgGST3 +
        hdnOthChrgGST4 +
    ...
    double txtTotGST = a11 - a2;

    double n = txtTotBasicAmt +
        Tot_otherChargeWithTax +
        Tot_otherChargeExcludeTax +
        txtTotGST;
    //print("djkfdnetamnt" + " NetAmnt " + n.toStringAsFixed(2));
    ...
    double txtTotNetAmt = roundDouble(n, 0);
    double txtRoff = roundDouble(n, 0) - roundDouble(n, 2);
    //double txtTotGST1 = txtTotGST - acurabath_amnt;
    List<double> addtional = [
      0,
      hdnTotItemGST,
      txtTotGST,
  ...
  static List<QuotationTable1> txtHeadDiscount_WithZero1(
      List<QuotationTable1> qtTable,
      double txtHeadDiscount,
      String CompanyStateID,
      String CustomerStateID) {
