...
class PurchaseOrderHeaderDiscountCalculation {
  ...
  static List<PurchaseOrderTable> txtHeadDiscount_TextChanged(
      List<PurchaseOrderTable> qtTable,
      double txtHeadDiscount,
      String CompanyStateID,
      String CustomerStateID) {
    List<PurchaseOrderTable> outqtTable = [];

    double TotalAmt = 0;
    double HeaderDiscAmt = txtHeadDiscount != null ? txtHeadDiscount : 0;
    double HeaderDiscItemWise = 0;
    if (qtTable != null) {
      qtTable.forEach((PurchaseOrderTable car) {
      ...
      qtTable.forEach((PurchaseOrderTable car) {
        ...
        outqtTable.add(PurchaseOrderTable(
            car.PurchaseOrderNo,
  ...
  static List<PurchaseOrderTable> txtHeadDiscount_WithZero(
      List<PurchaseOrderTable> qtTable,
      double txtHeadDiscount,
      String CompanyStateID,
      String CustomerStateID) {
