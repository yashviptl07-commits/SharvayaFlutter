...
class SalesOrderHeaderDiscountCalculation {
  ...
  static List<SalesOrderTable> txtHeadDiscount_TextChanged(
    ...
    if (qtTable != null) {
      ...
      qtTable.forEach((SalesOrderTable car) {
        ...
        outqtTable.add(SalesOrderTable(
            car.SalesOrderNo,
  ...
  static List<SalesOrderTable> txtHeadDiscount_WithZero(
      List<SalesOrderTable> qtTable,
      double txtHeadDiscount,
      String CompanyStateID,
      String CustomerStateID) {
