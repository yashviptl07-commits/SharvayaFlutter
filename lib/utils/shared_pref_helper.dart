...
class SharedPrefHelper {
  ...
  static const String IS_TERMSANDCONDITION = "is_termsAndCondition";
...
/*  setAddress(String Address) async {
  ...
  CustomerCategoryResponse getCustomerCategoryData() {
    return CustomerCategoryResponse.fromJson(
        json.decode(getString(IS_CUSTOMER_CATEGORY_IN_DATA)));
  }

  CustomerSourceResponse getCustomerSourceData() {
    return CustomerSourceResponse.fromJson(
        json.decode(getString(IS_CUSTOMER_SOURCE_IN_DATA)));
  }

  DesignationApiResponse getCustomerDesignationData() {
    return DesignationApiResponse.fromJson(
        json.decode(getString(IS_CUSTOMER_DESIGNATION_IN_DATA)));
  }

  InquiryStatusListResponse getInquiryLeadStatus() {
    return InquiryStatusListResponse.fromJson(
        json.decode(getString(IS_INQUIRY_LEAD_STATUS_IN_DATA)));
  }

  FollowerEmployeeListResponse getFollowerEmployeeList() {
    return FollowerEmployeeListResponse.fromJson(
        json.decode(getString(IS_FOLLOWER_EMPLOYEE_LIST_IN_DATA)));
  }

  ALL_EmployeeList_Response getALLEmployeeList() {
    return ALL_EmployeeList_Response.fromJson(
        json.decode(getString(IS_ALL_EMPLOYEE_LIST_IN_DATA)));
  }

  FollowupTypeListResponse getFollowupTypeListResponse() {
    return FollowupTypeListResponse.fromJson(
        json.decode(getString(IS_FollowupTypeListResponse_IN_DATA)));
  }

  CloserReasonListResponse getFollowupCloserReason() {
    return CloserReasonListResponse.fromJson(
        json.decode(getString(IS_CloserReasonListResponse_IN_DATA)));
  }

  LeaveRequestTypeResponse getLeaveRequestType() {
    return LeaveRequestTypeResponse.fromJson(
        json.decode(getString(IS_LeaveRequestTypeResponse_IN_DATA)));
  }

  ExpenseTypeResponse getExpenseType() {
    return ExpenseTypeResponse.fromJson(
        json.decode(getString(IS_EXPENSE_TYPE_IN_DATA)));
  }
  ...
  bool isTermsAndCondition() {
    return getBool(IS_TERMSANDCONDITION) ?? false;
  }
